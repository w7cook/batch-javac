...
public class BasicSecureObj extends BasicSecureInterface {
	int inc;
	public BasicSecureObj(int inc) {
		super();
		this.inc = inc;
	}
	...
	public BasicSecureObj bar(int x) {
		return new BasicSecureObj(inc + x);
	}
	public byte[] getImage(String name) throws IOException {
		FileInputStream fis = new FileInputStream("images/" + name + ".jpg");
