  ...
  public void Linq47()
  {
	...
	/*public void Batch47() {
	  ...
	  for (Northwind db : connection) {
	    ...
	    Fun<Product, Category> projectCat = new Fun<Product, Category>() { public Category apply(Product p) {return p.Category;} };
	    for (Category c : db.Products.project(projectCat).distinct())
	      print("{0}", c);
	  }
	}*/
  ...
  public void Linq49()
  {
	...
	/*public void Batch49() {
	  ...
	  for (Northwind db : connection) {
	    ...
	    Fun<Product, String> firstCharProductF = new Fun<Product, String>() {public String apply(Product p) {return p.ProductName;}};
	    Fun<Category, String> firstCharCategoryF = new Fun<Category, String>() {public String apply(Category c) {return c.CategoryName;}};      
	  }
	}*/
