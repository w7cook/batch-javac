...
public abstract class Regex {
  ...
  public static void main(String[] args) {
    Regex re = Civet.CT(star(alt(fromString("a"), fromString("bb"))));
    String in = args[0];
    boolean matched = match(re, in);
  ...
  static boolean match(Regex e, String input) {
    ...
    for (Character ce : e.first())
      if (c.equals(ce))
        return match(e.derivative(ce), input.substring(1));
    return false;
  }
  ...
  public static boolean match2(Regex e, String input) {
    for (char c : input.toCharArray())
      for (char candidate : e.first())
        if (c == candidate)
          e = e.derivative(candidate);
    return e.canBeEmpty();
  }

  // public static boolean match2(Regex e, String input) {
  // Machine m = e.explode(); // CT
  // return e.canBeEmpty();
  // }
  ...
  static Regex fromString(String s) {
    if (s.length() == 1)
      return lit(s.charAt(0));
    else
      return seq(lit(s.charAt(0)), fromString(s.substring(1)));
  }
...
class Alt extends Regex {
  ...
  public static Regex create(Regex r1, Regex r2) {
    if (r1 instanceof Empty && r2 instanceof Empty)
      return new Empty();
    if (r1 instanceof Null && r2 instanceof Null)
      return new Null();
    if (r1 instanceof Alt && r2 instanceof Alt) {
      boolean remove1 = false;
      boolean remove2 = false;
      if (((Alt) r1).re1.equals(((Alt) r2).re1)
          || ((Alt) r1).re1.equals(((Alt) r2).re2))
        remove1 = true;
      if (((Alt) r1).re2.equals(((Alt) r2).re1)
          || ((Alt) r1).re2.equals(((Alt) r2).re2))
        remove2 = true;
      if (remove1 && remove2)
        return r2;
      if (remove1)
        return Alt.create(((Alt) r1).re2, r2);
      if (remove2)
        return Alt.create(((Alt) r1).re1, r2);
    } else if (r1 instanceof Alt) {
      if (((Alt) r1).re1.equals(r2) || ((Alt) r1).re2.equals(r2))
        return r1;
    } else if (r2 instanceof Alt) {
      if (((Alt) r2).re1.equals(r1) || ((Alt) r2).re2.equals(r1))
        return r2;
    }
  ...
  public Regex simplify() {
    ...
    if (tre1 instanceof Empty && tre2 instanceof Empty)
      return new Empty();
    if (tre1 instanceof Null && tre2 instanceof Null)
      return new Null();
  ...
  public boolean eq(Regex obj) {
    ...
    if (re1 == null) {
      if (other.re1 != null)
        return false;
    } else if (!re1.equals(other.re1))
      return false;
    if (re2 == null) {
      if (other.re2 != null)
        return false;
    } else if (!re2.equals(other.re2))
      return false;
    return true;
  }
...
class Seq extends Regex {
  ...
  @Override
  public Regex derivative(Character c) {
    if (re1 instanceof Empty)
      return re2.derivative(c);
    if (re2 instanceof Empty)
      return re1.derivative(c);
...
class Star extends Regex {
  ...
  @Override
  public Regex derivative(Character c) {
    if (re instanceof Empty)
      return re.derivative(c);
