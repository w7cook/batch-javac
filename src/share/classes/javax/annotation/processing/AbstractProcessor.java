 ...
 * {@linkplain #getSupportedAnnotationTypes annotations}, and
...
public abstract class AbstractProcessor implements Processor {
   ...
   * an unmodifiable set with the same set of strings as the annotation. If the
   * class is not so annotated, an empty set is returned.
   * 
   ...
   * argument. An {@code IllegalStateException} will be thrown if this method is
   * called more than once on the same object.
   * 
   * @param processingEnv
   *          environment to access facilities the tool framework provides to
   *          the processor
  ...
  /**
   * Returns {@code true} if this object has been {@linkplain #init initialized}
