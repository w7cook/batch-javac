 ...
 * 
 * <p>
 * To implement operations based on the class of an {@code TypeMirror} object,
 * either use a {@linkplain TypeVisitor visitor} or use the result of the
 ...
 * implement multiple {@code TypeMirror} subinterfaces.
 * 
...
public interface TypeMirror {
   ...
   * string should be of a form suitable for representing this type in source
   * code. Any names embedded in the result are qualified if possible.
   * 
