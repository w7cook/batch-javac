...
public abstract class AbstractElementVisitor6<R, P> implements
   ...
   * {@link Element#accept accept} method. The invocation {@code v.visit(elem)}
   * is equivalent to {@code elem.accept(v,
   * p)}.
   * 
   * @param e
   ...
   * additional parameter. The invocation {@code v.visit(elem)} is equivalent to
   * {@code elem.accept(v,
   * null)}.
   * 
   * @param e
