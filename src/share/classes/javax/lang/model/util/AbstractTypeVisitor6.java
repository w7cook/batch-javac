...
public abstract class AbstractTypeVisitor6<R, P> implements TypeVisitor<R, P> {
   ...
   * {@code v.visit(t, p)} is equivalent to {@code t.accept(v, p)}.
   * 
   * @param t
   *          the type to visit
   * @param p
   ...
   * 
   * <p>
   * The default implementation of this method in {@code AbstractTypeVisitor6}
   * will always throw {@code UnknownTypeException}. This behavior is not
