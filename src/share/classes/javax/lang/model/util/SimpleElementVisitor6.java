 ...
 * 
 * For constructs introduced in {@code RELEASE_7} and later,
 * {@code visitUnknown} is called instead.
 * 
 * <p>
 ...
 *          {@code Void} for visitors that do not need an additional parameter.
 * 
...
public class SimpleElementVisitor6<R, P> extends AbstractElementVisitor6<R, P> {
  /**
   * Default value to be returned; {@link #defaultAction defaultAction} returns
   ...
   * returns {@link #DEFAULT_VALUE}; subclasses will commonly override this
   * method.
   * 
   * @param e
   ...
   * {@code RESOURCE_VARIABLE} in which case {@code visitUnknown} is called.
   * 
   * @param e
   *          {@inheritDoc}
   * @param p
