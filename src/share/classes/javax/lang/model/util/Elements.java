...
public interface Elements {
   ...
   * {@code /**}" , ends with a separate "<code>*&#47</code>", and immediately
   * precedes the element, ignoring white space. Therefore, a documentation
   * comment contains at least three"{@code *}" characters. The text returned
   * for the documentation comment is a processed form of the comment as it
   * appears in source code. The leading "{@code /**}" and trailing "
   * <code>*&#47</code>" are removed. For lines of the comment starting after
   * the initial "{@code /**}", leading white space characters are discarded as
   * are any consecutive "{@code *}" characters appearing after the white space
   * or starting the line. The processed lines are then concatenated together
   * (including line terminators) and returned.
   * 
   * @param e
   *          the element being examined
   * @return the documentation comment of the element, or {@code null} if there
   *         is none
   * @jls 3.6 White Space
   */
   ...
   * method. When a non-abstract method overrides an abstract one, the former is
   * also said to <i>implement</i> the latter.
   * 
   * <p>
   ...
   * value or a string. The text returned is in a form suitable for representing
