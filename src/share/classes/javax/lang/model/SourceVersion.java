...
public enum SourceVersion {
  /*
   * Summary of language evoluation 1.1: nested classes 1.2: strictfp 1.3: no
   ...
   * 
   * The language described in <cite>The Java&trade; Language Specification,
   * Second Edition</cite>, which includes the {@code strictfp} modifier.
   */
  RELEASE_2,
   ...
   * autoboxing, var-args, enhanced {@code for} loop, and hexadecimal
  ...
  /**
   * Returns the latest source version fully supported by the current execution
   * environment. {@code RELEASE_5} or later must be returned.
   * 
   ...
   * {@link Character#isJavaIdentifierStart(int)} returns {@code true}, followed
   * only by characters for which {@link Character#isJavaIdentifierPart(int)}
   * returns {@code true}. This pattern matches regular identifiers, keywords,
   * and the literals {@code "true"}, {@code "false"}, and {@code "null"}. The
   * method returns {@code false} for all other strings.
   * 
   * @param name
   *          the string to check
   * @return {@code true} if this string is a syntactically valid identifier or
  ...
  /**
   * Returns whether or not {@code name} is a syntactically valid qualified name
   * in the latest source version. Unlike {@link #isIdentifier isIdentifier},
   * this method returns {@code false} for keywords and literals.
   * 
   * @param name
   *          the string to check
  ...
  static {
    ...
    String[] kws = { "abstract", "continue", "for", "new", "switch", "assert",
        "default", "if", "package", "synchronized", "boolean", "do", "goto",
