...
public interface TypeElement extends Element, Parameterizable,
   ...
   * {@linkplain javax.lang.model.element general accuracy requirements} and the
   * ordering behavior required of this interface, the list of enclosed elements
   * will be returned in the natural order for the originating source of
   * information about the type. For example, if the information about the type
   * is originating from a source file, the elements will be returned in source
   * code order. (However, in that case the the ordering of synthesized
   ...
   *         by this interface, or an empty list if there are none
   */
   ...
   * lexically enclosing element for a {@linkplain NestingKind#isNested nested}
   * type.
   * 
