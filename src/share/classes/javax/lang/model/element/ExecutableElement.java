...
public interface ExecutableElement extends Element, Parameterizable {
   ...
   * kind {@link TypeKind#VOID VOID} if this executable is not a method, or is a
   ...
   * Returns {@code null} if this method is not an annotation type element, or
   * if it is an annotation type element with no default value.
   * 
   ...
   * initializer, the name {@code "<clinit>"} is returned, and for an anonymous
