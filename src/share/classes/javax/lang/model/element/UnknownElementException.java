...
public class UnknownElementException extends UnknownEntityException {
  ...
  /**
   * Creates a new {@code UnknownElementException}. The {@code p} parameter may
   * be used to pass in an additional argument with information about the
  ...
  /**
   * Returns the unknown element. The value may be unavailable if this exception
