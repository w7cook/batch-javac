...
public interface StandardJavaFileManager extends JavaFileManager {
   ...
   * @param b
   *          a file object
   * @return true if the given file objects represent the same canonical file or
   *         zip file entry; false otherwise
   * 
  ...
  /**
   * Associates the given path with the given location. Any previous value will
   * be discarded.
   * 
   * @param location
   *          a location
   ...
   *           exactly one element
   * @throws IOException
   *           if location is an output location and path does not represent an
   *           existing directory
   */
   ...
   * @param location
   *          a location
   * @return a list of files or {@code null} if this location has no associated
   *         path
   * @see #setLocation
   */
