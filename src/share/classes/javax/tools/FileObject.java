...
public interface FileObject {
   ...
   * given by the user. For example, if the user writes the filename
   * {@code "BobsApp\Test.java"} on the command line, this method should return
   * {@code "BobsApp\Test.java"} whereas the {@linkplain #toUri toUri} method
   * might return
   ...
   * reader may report a diagnostic unless {@code ignoreEncodingErrors} is true.
   * 
   ...
   * addition, a diagnostic may be reported unless {@code ignoreEncodingErrors}
   * is true.
   * 
   * @param ignoreEncodingErrors
   *          ignore encoding errors if true
