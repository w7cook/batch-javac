...
public interface JavaFileObject extends FileObject {
  ...
  enum Kind {
     ...
     * file object. If no convention exists, the empty string ({@code ""}) is
     * used.
     */
   ...
   * kind. A simple name is a single identifier (not qualified) as defined in
   * <cite>The Java&trade; Language Specification</cite>, section 6.2
   ...
   * {@link NestingKind#LOCAL} or {@link NestingKind#ANONYMOUS}. If the nesting
   * level is not known or this file object does not represent a class file this
   * method returns {@code null}.
   * 
   * @return the nesting kind, or {@code null} if the nesting kind is not known
   */
