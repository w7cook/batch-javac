...
public class SimpleJavaFileObject implements JavaFileObject {
  ...
  /**
   * This implementation returns {@code 0L}. Subclasses can change this behavior
   * as long as the contract of {@link FileObject} is obeyed.
   * 
   * @return {@code 0L}
   */
   ...
   * This method returns true if the given kind is equal to the kind of this
   * object, and if the path is equal to {@code simpleName + kind.extension} or
   * if it ends with {@code "/" + simpleName + kind.extension}.
   * 
   * <p>
  ...
  public boolean isNameCompatible(String simpleName, Kind kind) {
    ...
    return kind.equals(getKind())
        && (baseName.equals(toUri().getPath()) || toUri().getPath().endsWith(
            "/" + baseName));
  }
