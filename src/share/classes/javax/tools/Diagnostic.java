...
public interface Diagnostic<S> {
  ...
  enum Kind {
     ...
     * specification. For example, the Java&trade; Language Specification, 3rd
     * Ed. mandates warnings on certain unchecked operations and the use of
     * deprecated methods.
     */
    MANDATORY_WARNING,
    /**
   ...
   * 
   * @return the source object associated with this diagnostic. {@code null} if
   *         no source object is associated with the diagnostic.
   */
  S getSource();
   ...
   *         {@link #getSource()} would return {@code null} or if no location is
   *         suitable
   */
  long getPosition();
   ...
   * implementation-dependent. If the locale is {@code null} use the default
   * locale.
   * 
   * @param locale
