...
public interface DisassemblerTool extends Tool, OptionChecker {
  ...
  /**
   * Creates a future for a disassembly task with the given components and
   * arguments. The task might not have completed as described in the
   * DissemblerTask interface.
   * 
   * <p>
   ...
   */
  DisassemblerTask getTask(Writer out, JavaFileManager fileManager,
  ...
  /**
   * Interface representing a future for a disassembly task. The task has not
