 ...
 * 
 * <p>
 * Nothing described in this source file is part of any supported API. If you
 * write code that depends on this, you do so at your own risk. This code and
 * its internal interfaces are subject to change or deletion without notice.
 */
public class Main {
   ...
   * <tt>NullPointerException</tt> is thrown. Output is directed to
   * <tt>System.err</tt>.
   * 
   * @param args
   *          The command line parameters.
  ...
  /**
   * Programmatic interface. If any argument is <tt>null</tt>, a
   * <tt>NullPointerException</tt> is thrown.
   * 
   * @param args
   *          The command line parameters.
   * @param out
   *          Where the tool's output is directed.
   */
  ...
  /**
   * Programmatic interface. If <tt>factory</tt> or <tt>args</tt> is
   * <tt>null</tt>, a <tt>NullPointerException</tt> is thrown. The &quot;
   * <tt>-factory</tt>&quot; and &quot;<tt>-factorypath</tt>&quot; command line
   * parameters are ignored by this entry point. Output is directed to
   * <tt>System.err</tt>.
   * 
   * @param factory
   *          The annotation processor factory to use
   * @param args
   *          The command line parameters.
   */
  ...
  /**
   * Programmatic interface. If any argument is <tt>null</tt>, a
   * <tt>NullPointerException</tt> is thrown. The &quot;<tt>-factory</tt>&quot;
   * and &quot;<tt>-factorypath</tt>&quot; command line parameters are ignored
   * by this entry point.
   * 
   * @param factory
   *          The annotation processor factory to use
  ...
  private static int processing(AnnotationProcessorFactory factory,
    ...
    com.sun.tools.apt.main.Main compiler = new com.sun.tools.apt.main.Main(
        "apt", out);
