...
public class DeclarationsImpl implements Declarations {
  ...
  private static final Context.Key<Declarations> declarationsKey = new Context.Key<Declarations>();
  ...
  /**
   * {@inheritDoc} See sections 8.3 and 8.4.6 of <cite>The Java&trade; Language
   * Specification</cite>
   */
  ...
  /**
   * {@inheritDoc} See section 8.4.6.1 of <cite>The Java&trade; Language
   * Specification</cite>
   */
