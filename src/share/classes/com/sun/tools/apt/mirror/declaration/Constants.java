...
class Constants {
  ...
  /**
   * Converts a constant in javac's internal representation (in which boolean,
   * char, byte, short, and int are each represented by an Integer) into
   * standard representation. Other values (including null) are returned
   * unchanged.
   */
   ...
   * Equivalent to <tt>getFormatter(new StringBuilder())</tt>.
   */
  ...
  /**
   * Returns a formatter for generating the text of constant expressions. Also
   * generates the text of constant "pseudo-expressions" for annotations and
   * array-valued annotation elements.
   * 
   * @param buf
  ...
  /**
   * Utility class used to generate the text of constant expressions. Also
   * generates the text of constant "pseudo-expressions" for annotations and
   * array-valued annotation elements.
   */
  static class Formatter {
    ...
    /**
     * Appends a constant whose type is not statically known by dispatching to
     * the appropriate overloaded append method.
     */
    ...
    /**
     * Appends the class literal corresponding to a type. Should only be invoked
     * for types that have an associated literal. e.g: "java.lang.String.class"
    ...
    /**
     * Appends the fully qualified name of an enum constant. e.g:
    ...
    /**
     * Appends the text of an annotation pseudo-expression. e.g:
     * "@pkg.Format(linesep='\n')"
     */
    ...
    /**
     * Appends the elements of a collection, enclosed within braces and
     * separated by ", ". Useful for array-valued annotation elements.
     */
    ...
    /**
     * Appends a char (unquoted), using escapes for those that are not printable
     * ASCII. We don't know what is actually printable in the locale in which
     * this result will be used, so ASCII is our best guess as to the least
     * common denominator.
     */
