...
public class WildcardTypeImpl extends TypeMirrorImpl implements WildcardType {
  ...
  /**
   * Returns the string form of a wildcard type, consisting of "?" and any
   * "extends" or "super" clause. Delimiting brackets are not included. Class
   * names are qualified.
   */
  ...
  public Collection<ReferenceType> getUpperBounds() {
    return type.isSuperBound() ? Collections.<ReferenceType> emptyList()
  ...
  public Collection<ReferenceType> getLowerBounds() {
    return type.isExtendsBound() ? Collections.<ReferenceType> emptyList()
        : typeToCollection(type.type);
  }

  /**
   * Gets the ReferenceType for a javac Type object, and returns it in a
   * singleton collection. If type is null, returns an empty collection.
   */
  ...
  /**
   * Returns the string form of a wildcard type, consisting of "?" and any
   * "extends" or "super" clause. See {@link #toString()} for details.
   */
