...
abstract class DeclaredTypeImpl extends TypeMirrorImpl implements DeclaredType {
  ...
  /**
   * Returns a string representation of this declared type. This includes the
   * type's name and any actual type arguments. Type names are qualified.
   */
  ...
  /**
   * Returns a string representation of this declared type. See
