...
public class DeclarationMaker {
  ...
  /**
   * Returns the package declaration for the package with the given name. Name
   * is fully-qualified, or "" for the unnamed package. Returns null if package
  ...
  /**
   * Returns the type declaration for a class symbol. Forces completion, and
  ...
  /**
   * Is a method an annotation type element? It is if it's declared in an
   * annotation type.
   */
