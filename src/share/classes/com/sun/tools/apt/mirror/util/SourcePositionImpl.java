...
public class SourcePositionImpl implements SourcePosition {
  ...
  private int pos; // file position, in javac's internal
                   // format
  private Position.LineMap linemap;

  public SourcePositionImpl(JavaFileObject sourcefile, int pos,
  ...
  public String toString() {
    int ln = line();
    return (ln == Position.NOPOS) ? sourcefile.getName() : sourcefile.getName()
        + ":" + ln;
  }
