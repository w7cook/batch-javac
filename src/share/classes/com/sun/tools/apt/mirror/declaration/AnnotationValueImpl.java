...
public class AnnotationValueImpl implements AnnotationValue {
  ...
  AnnotationValueImpl(AptEnv env, Attribute attr,
  ...
  private class ValueVisitor implements Attribute.Visitor {
    ...
    public void visitClass(Attribute.Class c) {
      value = env.typeMaker.getType(env.jctypes.erasure(c.type));
    }
    ...
    public void visitCompound(Attribute.Compound c) {
      value = new AnnotationMirrorImpl(env, c, (annotation == null) ? null
          : annotation.getDeclaration());
    }

    public void visitArray(Attribute.Array a) {
      ArrayList<AnnotationValue> vals = new ArrayList<AnnotationValue>(
          a.values.length);
