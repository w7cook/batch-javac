...
class PrimitiveTypeImpl extends TypeMirrorImpl implements PrimitiveType {
  ...
  private static Type getType(AptEnv env, Kind kind) {
    ...
    case BYTE:
      return env.symtab.byteType;
    case SHORT:
      return env.symtab.shortType;
    case INT:
      return env.symtab.intType;
    case LONG:
      return env.symtab.longType;
    case CHAR:
      return env.symtab.charType;
    case FLOAT:
      return env.symtab.floatType;
    case DOUBLE:
      return env.symtab.doubleType;
    default:
