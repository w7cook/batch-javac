...
public class AptEnv {
  ...
  public Names names; // javac's
                      // name
                      // table
  public Symtab symtab; // javac's
                        // predefined
                        // symbols
  public Types jctypes; // javac's
                        // type
                        // utilities
  public Enter enter; // javac's
                      // enter
                      // phase
  public Attr attr; // javac's
                    // attr
                    // phase
                    // (to
                    // evaluate
                    // constant
                    // initializers)
  public TypeMaker typeMaker; // apt's
                              // internal
                              // type
                              // utilities
  public DeclarationMaker declMaker; // apt's
                                     // internal
                                     // declaration
                                     // utilities

  private static final Context.Key<AptEnv> aptEnvKey = new Context.Key<AptEnv>();
