 ...
 * 
 * <p>
 * The "dynamic proxy return form" of an attribute element value is the form
...
class AnnotationProxyMaker {
  ...
  private AnnotationProxyMaker(AptEnv env, Attribute.Compound attrs,
   ...
   */
  public static <A extends Annotation> A generateAnnotation(AptEnv env,
      Attribute.Compound attrs, Class<A> annoType) {
  ...
  private Map<String, Object> getAllReflectedValues() {
    ...
    for (Map.Entry<MethodSymbol, Attribute> entry : getAllValues().entrySet()) {
  ...
  /**
   * Returns a map from element symbols to their values. Includes all elements,
   * whether explicit or defaulted.
   */
  ...
  private class ValueVisitor implements Attribute.Visitor {
    ...
    public void visitClass(Attribute.Class c) {
      value = new MirroredTypeExceptionProxy(env.typeMaker.getType(c.type));
    }
    ...
    public void visitCompound(Attribute.Compound c) {
      try {
        Class<? extends Annotation> nested = runtimeType
  ...
  private static final class MirroredTypeExceptionProxy extends ExceptionProxy {
    ...
    public int hashCode() {
      ...
      return (t != null) ? t.hashCode() : ex.getQualifiedName().hashCode();
    }

    public boolean equals(Object obj) {
      TypeMirror t = ex.getTypeMirror();
      return t != null && obj instanceof MirroredTypeExceptionProxy
          && t.equals(((MirroredTypeExceptionProxy) obj).ex.getTypeMirror());
    }
  ...
  private static final class MirroredTypesExceptionProxy extends ExceptionProxy {
    ...
    public int hashCode() {
      ...
      return (ts != null) ? ts.hashCode() : ex.getQualifiedNames().hashCode();
    }

    public boolean equals(Object obj) {
      Collection<TypeMirror> ts = ex.getTypeMirrors();
      return ts != null && obj instanceof MirroredTypesExceptionProxy
          && ts.equals(((MirroredTypesExceptionProxy) obj).ex.getTypeMirrors());
    }
