...
public class TypeMaker {
  ...
  private static final Context.Key<TypeMaker> typeMakerKey = new Context.Key<TypeMaker>();
  ...
  public TypeMirror getType(Type t) {
    ...
    case CLASS:
      return getDeclaredType((Type.ClassType) t);
    case WILDCARD:
      return new WildcardTypeImpl(env, (Type.WildcardType) t);
    case TYPEVAR:
      return new TypeVariableImpl(env, (Type.TypeVar) t);
    case ARRAY:
      return new ArrayTypeImpl(env, (Type.ArrayType) t);
    case VOID:
      return voidType;
    default:
  ...
  public DeclaredType getDeclaredType(Type.ClassType t) {
    return hasFlag(t.tsym, Flags.ANNOTATION) ? new AnnotationTypeImpl(env, t)
  ...
  /**
   * Returns the string representation of a type. Bounds of type variables are
   * not included; bounds of wildcard types are. Type names are qualified.
   */
