...
public class PrintAP implements AnnotationProcessor {
  ...
  static class PrintingVisitors {
    ...
    static Set<Modifier> INTERFACE_MEMBER_ELIDES = EnumSet.of(ABSTRACT, PUBLIC,
        STATIC, FINAL);
    ...
    PrintingVisitors(AnnotationProcessorEnvironment env) {
      ...
      this.java_lang_annotation_Annotation = env
          .getTypeDeclaration("java.lang.annotation.Annotation");
    }
    ...
    class PrePrinting extends SimpleDeclarationVisitor {
      ...
      public void visitFieldDeclaration(FieldDeclaration d) {
        ...
        printModifiers(
            d,
            (d.getDeclaringType() instanceof InterfaceDeclaration) ? INTERFACE_MEMBER_ELIDES
                : EMPTY_ELIDES);
        System.out.print(d.getType().toString() + " " + d.getSimpleName());
    ...
    private void printParameters(ExecutableDeclaration ex) {
      ...
      case 1:
        for (ParameterDeclaration parameter : parameters) {
          ...
          if (ex.isVarArgs()) {
            System.out.print(((ArrayType) parameter.getType())
                .getComponentType());
            System.out.print("...");
          } else
    ...
    private void printFormalTypeParameterSet(
        Collection<TypeParameterDeclaration> typeParams, boolean pad) {
    ...
    private void printInterfaces(AnnotationTypeDeclaration d) {
      Collection<InterfaceType> interfaces = new HashSet<InterfaceType>(
          d.getSuperinterfaces());
    ...
    DeclarationVisitor getPrintingVisitor() {
      return DeclarationVisitors.getSourceOrderDeclarationScanner(
          new PrePrinting(), new PostPrinting());
    }
  }
