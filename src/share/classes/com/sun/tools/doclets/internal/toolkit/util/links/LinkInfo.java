...
public abstract class LinkInfo {
  ...
  /**
   * The executable member doc we want to link to. Null if we are not linking to
  ...
  /**
   * By default, the link can be to the page it's already on. However, there are
   * cases where we don't want this (e.g. heading of class page).
   */
  ...
  /**
   * Return the id indicating where the link appears in the documentation. This
   * is used for special processing of different types of links.
   * 
