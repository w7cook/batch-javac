...
public interface AnnotationTypeWriter {
   ...
   * 
   * @return annotation content header that needs to be added to the
   *         documentation
   */
   ...
   * 
   * @return annotation information tree header that needs to be added to the
   *         documentation
   */
   ...
   *          content tree containing the annotation information
   ...
   * 
   * @param modifiers
   *          the modifiers for the signature
   * @param annotationInfoTree
   ...
   * 
   * @param memberDetails
   *          the content tree representing member details marker
   */
   ...
   * 
   * @param memberTree
   *          the content tree that will be modified and returned
   ...
   * 
   * @param memberTree
   *          the content tree that will be used to build the summary tree
   ...
   * 
   * @param memberTree
   *          the content tree that will be used to build the details tree
   ...
   * 
   * @param contentTree
   *          content tree that will be printed as a document
   */
