...
/**
 * Build list of all the deprecated packages, classes, constructors, fields and
 * methods.
 * 
...
public class DeprecatedAPIListBuilder {
  ...
  /**
   * Build the sorted list of all the deprecated APIs in this run. Build
   * separate lists for deprecated packages, classes, constructors, methods and
   * fields.
   * 
   * @param configuration
   *          the current configuration of the doclet.
   ...
   * 
   * @param list
   *          List of all the particular deprecated members, e.g. methods.
   * @param members
   ...
   * 
   * @param the
   *          constant representing the type of list being returned.
   */
