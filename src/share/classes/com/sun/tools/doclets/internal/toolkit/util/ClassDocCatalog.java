...
/**
 * This class acts as an artificial PackageDoc for classes specified on the
 * command line when running Javadoc. For example, if you specify several
 * classes from package java.lang, this class will catalog those classes so that
 * we can retrieve all of the classes from a particular package later.
 * 
...
public class ClassDocCatalog {
   ...
   * 
   * @param classdocs
   *          the array of ClassDocs to catalog
   */
   ...
   * 
   * @param classdoc
   *          the ClassDoc to add to the catelog.
   */
   ...
   *          the ClassDoc to add to the catelog.
   * @param map
   *          the Map to add the ClassDoc to.
   */
  ...
  /**
   * Return all of the classes specified on the command-line that belong to the
   * given package.
   * 
   * @param packageDoc
   *          the package to return the classes for.
   */
  public ClassDoc[] allClasses(PackageDoc pkgDoc) {
    return pkgDoc.isIncluded() ? pkgDoc.allClasses() : getArray(allClasses,
   ...
   * 
   * @param packageName
   *          the name of the package specified on the command-line.
   */
   ...
   * @param packageName
   *          the name to check.
   * @return true if this catalog has any information about classes in the given
   *         package.
   */
  ...
  /**
   * Return all of the errors specified on the command-line that belong to the
   * given package.
   * 
   * @param packageName
   *          the name of the package specified on the command-line.
  ...
  /**
   * Return all of the exceptions specified on the command-line that belong to
   * the given package.
   * 
   * @param packageName
   *          the name of the package specified on the command-line.
  ...
  /**
   * Return all of the enums specified on the command-line that belong to the
   * given package.
   * 
   * @param packageName
   *          the name of the package specified on the command-line.
  ...
  /**
   * Return all of the annotation types specified on the command-line that
  ...
  /**
   * Return all of the interfaces specified on the command-line that belong to
   * the given package.
   * 
   * @param packageName
   *          the name of the package specified on the command-line.
  ...
  /**
   * Return all of the ordinary classes specified on the command-line that
   * belong to the given package.
   * 
   * @param packageName
   *          the name of the package specified on the command-line.
