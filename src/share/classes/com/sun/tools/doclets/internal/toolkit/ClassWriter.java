...
public interface ClassWriter {
   ...
   * 
   * @return class informaion tree header that needs to be added to the
   *         documentation
   */
   ...
   * 
   * @param classInfoTree
   *          content tree conatining the class information
   ...
   * 
   * @param memberTree
   *          the content tree used to build the summary tree
   ...
   * 
   * @param memberTree
   *          the content tree used to build the details tree
