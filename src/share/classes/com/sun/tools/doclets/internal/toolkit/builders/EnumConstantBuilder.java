...
public class EnumConstantBuilder extends AbstractMemberBuilder {
  ...
  /**
   * The index of the current enum constant that is being documented at this
   * point in time.
   */
  ...
  public static EnumConstantBuilder getInstance(Configuration configuration,
    ...
    if (configuration.getMemberComparator() != null) {
      Collections.sort(builder.enumConstants,
  ...
  /**
   * Returns a list of enum constants that will be documented for the given
   * class. This information can be used for doclet specific documentation
   * generation.
   * 
   * @param classDoc
  ...
  public void buildEnumConstant(XMLNode node, Content memberDetailsTree) {
    ...
    if (size > 0) {
      Content enumConstantsDetailsTree = writer
          .getEnumConstantsDetailsTreeHeader(classDoc, memberDetailsTree);
      for (currentEnumConstantsIndex = 0; currentEnumConstantsIndex < size; currentEnumConstantsIndex++) {
      ...
      memberDetailsTree.addContent(writer
          .getEnumConstantsDetails(enumConstantsDetailsTree));
    }
  }
  ...
  public void buildSignature(XMLNode node, Content enumConstantsTree) {
    enumConstantsTree.addContent(writer.getSignature((FieldDoc) enumConstants
        .get(currentEnumConstantsIndex)));
  }
  ...
  public void buildTagInfo(XMLNode node, Content enumConstantsTree) {
    writer.addTags((FieldDoc) enumConstants.get(currentEnumConstantsIndex),
        enumConstantsTree);
  }
