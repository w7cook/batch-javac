...
public class AnnotationTypeBuilder extends AbstractBuilder {
   ...
   */
  public void buildAnnotationTypeDoc(XMLNode node, Content contentTree)
      throws Exception {
    contentTree = writer.getHeader(configuration
        .getText("doclet.AnnotationType") + " " + annotationTypeDoc.name());
    ...
    if ((configuration.packages == null || Arrays.binarySearch(
      ...
      Util.copyDocFiles(
          ...
          Util.getPackageSourcePath(configuration,
              ...
              + DirectoryManager.getDirectoryPath(annotationTypeDoc
                  .containingPackage()) + File.separator,
  ...
  public void buildAnnotationTypeInfo(XMLNode node,
    ...
    annotationContentTree.addContent(writer
        .getAnnotationInfo(annotationInfoTree));
  }
  ...
  public void buildAnnotationTypeSignature(XMLNode node,
    ...
    writer.addAnnotationTypeSignature(
        Util.replaceText(modifiers.toString(), "interface", "@interface"),
        annotationInfoTree);
  }
  ...
  public void buildMemberSummary(XMLNode node, Content annotationContentTree)
    ...
    annotationContentTree.addContent(writer
        .getMemberSummaryTree(memberSummaryTree));
  }
  ...
  public void buildAnnotationTypeMemberDetails(XMLNode node,
    ...
    if (memberDetailsTree.isValid()) {
      ...
      annotationContentTree.addContent(writer
          .getMemberDetailsTree(memberDetails));
    }
  }
