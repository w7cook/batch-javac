...
/**
 * This class is useful for searching a method which has documentation comment
 * and documentation tags. The method is searched in all the superclasses and
 * interfaces(subsequently super-interfaces also) recursively.
 * 
...
public abstract class MethodFinder {
  ...
  public MethodDoc searchInterfaces(ClassDoc cd, MethodDoc method) {
    MethodDoc[] implementedMethods = (new ImplementedMethods(method, null))
        .build();
