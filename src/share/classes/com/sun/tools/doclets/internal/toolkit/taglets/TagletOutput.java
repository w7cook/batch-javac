...
/**
 * The interface for taglet output. This interface is needed because different
 * doclets work with different formats of output. A single taglet can work with
 * any doclet that provides an implementation of taglet output.
 * 
 * @author Jamie Ho
 * @since 1.5
 */
public interface TagletOutput {
   ...
   * 
   * @param o
   *          an object representing the output.
   */
   ...
   * 
   * @param o
   *          a TagletOutput representing the output.
   */
