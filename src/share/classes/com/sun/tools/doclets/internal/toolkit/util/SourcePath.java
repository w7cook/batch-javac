...
public class SourcePath {
  ...
  /**
   * Build a default source path from the path strings specified by the
   * properties env.class.path.
   */
  public SourcePath() {
  ...
  /**
   * Initialize the SourcePath File array, which will contain only the directory
   * names from the given path string.
   * 
   * @param pathstr
   *          Path String.
   */
  private void init(String pathstr) {
    ...
    System.arraycopy((Object) tempPath, 0, (Object) sourcePath, 0,
        tempPathIndex);
  }
