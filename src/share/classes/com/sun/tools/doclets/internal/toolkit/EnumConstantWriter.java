...
public interface EnumConstantWriter {
   ...
   * 
   * @param enumConstant
   *          the enum constant being documented
   * @param enumConstantDetailsTree
   *          the content tree representing enum constant details
   ...
   * 
   * @param enumConstantsTree
   *          the content tree representing enum constants documentation
   * @param isLastContent
