...
public class BuilderFactory {
   ...
   * @param prevPkg
   *          the previous package being documented.
   * @param nextPkg
   ...
   */
  public AbstractBuilder getClassBuilder(ClassDoc classDoc, ClassDoc prevClass,
      ClassDoc nextClass, ClassTree classTree) throws Exception {
    return ClassBuilder
        .getInstance(configuration, classDoc, writerFactory.getClassWriter(
            classDoc, prevClass, nextClass, classTree));
  }
  ...
  public AbstractBuilder getMethodBuilder(ClassWriter classWriter)
      throws Exception {
    return MethodBuilder.getInstance(configuration, classWriter.getClassDoc(),
  ...
  public AbstractBuilder getAnnotationTypeOptionalMemberBuilder(
    ...
    return AnnotationTypeOptionalMemberBuilder.getInstance(configuration,
        annotationTypeWriter.getAnnotationTypeDoc(), writerFactory
  ...
  public AbstractBuilder getEnumConstantsBuilder(ClassWriter classWriter)
      throws Exception {
    return EnumConstantBuilder.getInstance(configuration,
