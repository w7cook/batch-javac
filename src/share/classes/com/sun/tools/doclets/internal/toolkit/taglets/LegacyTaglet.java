...
/**
 * This taglet acts as a wrapper to enable {@link com.sun.tools.doclets.Taglet}
 * type taglets to work with the current version of Javadoc. Note: this taglet
 * only works with legacy taglets (those compatible with Javadoc 1.4.x) that
 * writes strings. This taglet is able to wrap most most legacy taglets because
