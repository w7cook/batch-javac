...
public class DocFinder {
  ...
  public static class Input {
    ...
    /**
     * The taglet to search for documentation on behalf of. Null if we want to
     * search for overall documentation.
     */
    ...
    /**
     * Used to distinguish between type variable param tags and regular param
     * tags.
     */
  ...
  public static class Output {
    /**
     * The tag that holds the documentation. Null if documentation is not held
     * by a tag.
     */
    ...
    /**
     * When automatically inheriting throws tags, you sometime must inherit more
     * than one tag. For example if the method declares that it throws
  ...
  /**
   * Search for the requested comments in the given method. If it does not have
   * comments, return documentation from the overriden method if possible. If
   * the overriden method does not exist or does not have documentation to
   * inherit, search for documentation to inherit from implemented methods.
   * 
   * @param input
   *          the input object used to perform the search.
   * 
  ...
  public static Output search(Input input) {
    ...
    if (input.isInheritDocTag) {
      ...
      output.inlineTags = input.isFirstSentence ? input.method
          .firstSentenceTags() : input.method.inlineTags();
    ...
    MethodDoc[] implementedMethods = (new ImplementedMethods(input.method, null))
        .build(false);
