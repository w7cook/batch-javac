...
public interface MemberSummaryWriter {
   ...
   *          the content tree to which the member summary will be added
   ...
   * 
   * @param classDoc
   *          the class the summary table belongs to
   ...
   *          the class the summary belongs to
   * @param member
   *          the member that is documented
   * @param firstSentenceTags
   *          the tags for the sentence being documented
   * @param tableTree
   *          the content treeto which the information will be added
   * @param counter
   ...
   * @param member
   *          the inherited member that is being documented
   * @param isFirst
   ...
   * 
   * @param memberTree
   *          the content tree representating the member
