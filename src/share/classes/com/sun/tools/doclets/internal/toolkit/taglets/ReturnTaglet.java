 ...
 * @since 1.4
 */
public class ReturnTaglet extends BaseExecutableMemberTaglet implements
    InheritableTaglet {
  ...
  public void inherit(DocFinder.Input input, DocFinder.Output output) {
    ...
    if (tags.length > 0) {
      ...
      output.inlineTags = input.isFirstSentence ? tags[0].firstSentenceTags()
          : tags[0].inlineTags();
    }
  }
  ...
  public TagletOutput getTagletOutput(Doc holder, TagletWriter writer) {
    ...
    if (tags.length == 0) {
      ...
      tags = inheritedDoc.holderTag == null ? tags
          : new Tag[] { inheritedDoc.holderTag };
    }
