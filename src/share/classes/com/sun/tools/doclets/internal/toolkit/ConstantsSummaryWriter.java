...
public interface ConstantsSummaryWriter {
   ...
   * 
   * @param pkg
   *          the {@link PackageDoc} to index.
   * @param parsedPackageName
   *          the parsed package name. We only Write the first 2 directory
   *          levels of the package name. For example, java.lang.ref would be
   *          indexed as java.lang.*.
   * @param WriteedPackageHeaders
   *          the set of package headers that have already been indexed. We
   *          don't want to index something more than once.
   * @param contentListTree
   *          the content tree to which the link will be added
   */
  public abstract void addLinkToPackageContent(PackageDoc pkg,
      String parsedPackageName, Set<String> WriteedPackageHeaders,
   ...
   *          indexed as java.lang.*.
   * @param summariesTree
   *          the documentation tree to which the package name will be written
   */
  public abstract void addPackageName(PackageDoc pkg, String parsedPackageName,
   ...
   * 
   * @param cd
   *          the class whose constants are being documented.
   * @param fields
   *          the constants being documented.
   * @param classConstantTree
   *          the documentation tree to which theconstant member table content
   *          will be added
   */
   ...
   * 
   * @param contentTree
   *          content tree which should be printed
   */
