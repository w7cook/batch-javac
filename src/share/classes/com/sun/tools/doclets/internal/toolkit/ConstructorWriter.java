...
public interface ConstructorWriter {
   ...
   * 
   * @param constructor
   *          the constructor being documented
   * @param constructorDetailsTree
   *          the content tree representing constructor details
   ...
   */
  public void addDeprecated(ConstructorDoc constructor,
   ...
   * 
   * @param constructorDocTree
   *          the content tree representing constructor documentation
   * @param isLastContent
