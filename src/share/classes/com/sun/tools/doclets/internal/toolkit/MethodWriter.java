...
public interface MethodWriter {
   ...
   * @param methodDetailsTree
   *          the content tree representing method details
   ...
   * 
   * @param holder
   *          the holder type (not erasure) of the method
   * @param method
   *          the method being documented
   * @param methodDocTree
   ...
   * 
   * @param methodDocTree
   *          the content tree representing method documentation
   * @param isLastContent
