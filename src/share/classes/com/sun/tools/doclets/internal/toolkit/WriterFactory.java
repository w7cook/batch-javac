...
public interface WriterFactory {
   ...
   * 
   * @return the writer for the constant summary. Return null if this writer is
   *         not supported by the doclet.
   */
   ...
   * @param prevPkg
   *          the previous package that was documented.
   * @param nextPkg
   *          the next package being documented.
   * @return the writer for the package summary. Return null if this writer is
   *         not supported by the doclet.
   */
   ...
   * @param classTree
   *          the class tree.
   * @return the writer for the class. Return null if this writer is not
   *         supported by the doclet.
   */
   ...
   * @param prevType
   *          the previous type that was documented.
   * @param nextType
   *          the next type being documented.
   * @return the writer for the annotation type. Return null if this writer is
   *         not supported by the doclet.
   */
   ...
   * 
   * @param classWriter
   *          the writer for the class being documented.
   * @return the method writer for the give class. Return null if this writer is
   *         not supported by the doclet.
   */
   ...
   *          the writer for the annotation type being documented.
   ...
   * @param classWriter
   *          the writer for the class being documented.
   * @return the field writer for the give class. Return null if this writer is
   *         not supported by the doclet.
   */
   ...
   *         not supported by the doclet.
   */
  public abstract ConstructorWriter getConstructorWriter(ClassWriter classWriter)
      throws Exception;
   ...
   *          the writer for the class being documented.
   * @param memberType
   *          the {@link VisibleMemberMap} member type indicating the type of
   *          member summary that should be returned.
   * @return the summary writer for the give class. Return null if this writer
   *         is not supported by the doclet.
   * 
   * @see VisibleMemberMap
   * @throws IllegalArgumentException
   *           if memberType is unknown.
   */
