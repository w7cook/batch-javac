...
public abstract class LinkFactory {
   ...
   * 
   * @param linkInfo
   *          the information about the link to construct.
   * 
   ...
   *          the information about the link to construct.
   * @param isClassLabel
   *          true if this is a class label. False if it is the type parameters
   *          portion of the link.
   * @return the links to the type parameters.
   */
  public LinkOutput getTypeParameterLinks(LinkInfo linkInfo,
    ...
    if (((linkInfo.includeTypeInClassLinkLabel && isClassLabel) || (linkInfo.includeTypeAsSepLink && !isClassLabel))
        && vars.length > 0) {
      linkInfo.displayLength += 1;
  ...
  /**
   * Return &amp;lt;, which is used in type parameters. Override this if your
   * doclet uses something different.
   * 
