...
public class ImplementedMethods {
   ...
   * overridden by any other subinterface method which this class implements. If
   * it is not overidden, add it in the method list. Do this recursively for all
   * the extended interfaces for each interface from the array passed.
   */
  ...
  /**
   * Search in the method list and check if it contains a method which is
   * overridden by the method as parameter. If found, remove the overridden
   * method from the method list.
   * 
   * @param method
   *          Is this method overriding a method in the method list.
   */
  ...
  /**
   * Search in the already found methods' list and check if it contains a method
   * which is overriding the method parameter or is the method parameter itself.
   * 
   * @param method
   *          MethodDoc Method to be searched in the Method List for an
   *          overriding method.
   */
