...
public abstract class SubWriterHolderWriter extends HtmlDocletWriter {
  ...
  public SubWriterHolderWriter(ConfigurationImpl configuration, String filename)
      throws IOException {
    super(configuration, filename);
  }

  public SubWriterHolderWriter(ConfigurationImpl configuration, String path,
  ...
  public Content getSummaryTableTree(AbstractMemberWriter mw, ClassDoc cd) {
    ...
    table
        .addContent(getSummaryTableHeader(mw.getSummaryTableHeader(cd), "col"));
    return table;
  }
   ...
   *          the first sentence tags for the member to be documented
   * @param tdSummary
   *          the content tree to which the comment will be added
   */
   ...
   * 
   * @param contentTree
   *          the tree used to generate the member summary tree
   ...
   * 
   * @param contentTree
   *          the tree used to generate the member details tree
   ...
   * 
   * @param style
   *          the style class to be added to the content tree
   * @param contentTree
   *          the tree used to generate the complete member tree
   */
