...
public class ConstructorWriterImpl extends AbstractExecutableMemberWriter
  ...
  public ConstructorWriterImpl(SubWriterHolderWriter writer, ClassDoc classDoc) {
    ...
    List<ProgramElementDoc> constructors = new ArrayList<ProgramElementDoc>(
        visibleMemberMap.getMembersFor(classDoc));
  ...
  public Content getConstructorDetailsTreeHeader(ClassDoc classDoc,
    ...
    constructorDetailsTree.addContent(writer
        .getMarkerAnchor("constructor_detail"));
  ...
  public Content getConstructorDocTreeHeader(ConstructorDoc constructor,
    ...
    constructorDetailsTree.addContent(writer.getMarkerAnchor(writer
        .getAnchor(constructor)));
  ...
  public String[] getSummaryTableHeader(ProgramElementDoc member) {
    ...
    if (foundNonPubConstructor) {
      ...
      header = new String[] { configuration().getText("doclet.0_and_1",
          configuration().getText("doclet.Constructor"),
          configuration().getText("doclet.Description")) };
    }
    return header;
