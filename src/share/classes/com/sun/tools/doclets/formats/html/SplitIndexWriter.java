...
public class SplitIndexWriter extends AbstractIndexWriter {
   ...
   */
  public SplitIndexWriter(ConfigurationImpl configuration, String path,
      String filename, String relpath, IndexBuilder indexbuilder, int prev,
  ...
  /**
   * Generate separate index files, for each Unicode character, listing all the
   * members starting with the particular unicode character.
   * 
   * @param indexbuilder
   *          IndexBuilder built by {@link IndexBuilder}
  ...
  public static void generate(ConfigurationImpl configuration,
    ...
    try {
      for (int i = 0; i < indexbuilder.elements().length; i++) {
        ...
        indexgen = new SplitIndexWriter(configuration, path, filename, relpath,
  ...
  /**
   * Generate the contents of each index file, with Header, Footer, Member
   * Field, Method and Constructor Description.
   * 
   * @param unicode
   *          Unicode character referring to the character for the index.
   */
