 ...
 * This will be sub-classed by to generate overview-frame.html as well as
...
public abstract class AbstractPackageIndexWriter extends HtmlDocletWriter {
   ...
   * 
   * @param filename
   *          Name of the package index file to be generated.
   */
   ...
   * 
   * @param packages
   *          an array of packagedoc objects
   * @param text
  ...
  /**
   * Generate and prints the contents in the package index file. Call
   * appropriate methods from the sub-class in order to generate Frame or Non
   * Frame format.
   * 
   * @param title
   ...
   * 
   * @param body
   *          the document tree to which the overview will be added
   */
  ...
  /**
   * Adds package index contents. Call appropriate methods from the sub-classes.
   * Adds it to the body HtmlTree
   * 
   * @param packages
   *          array of packages to be documented
   * @param text
   *          string which will be used as the heading
   * @param tableSummary
   *          summary for the table
   * @param body
  ...
  /**
   * Adds the doctitle to the documentation tree, if it is specified on the
   * command line.
   * 
   * @param body
