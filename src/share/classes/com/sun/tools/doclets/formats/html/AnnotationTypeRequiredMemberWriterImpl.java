 ...
 */
public class AnnotationTypeRequiredMemberWriterImpl extends
    AbstractMemberWriter implements AnnotationTypeRequiredMemberWriter,
    MemberSummaryWriter {
   ...
   * 
   * @param writer
   *          the writer that will write the output.
  ...
  public Content getMemberSummaryHeader(ClassDoc classDoc,
    ...
    memberSummaryTree
        .addContent(HtmlConstants.START_OF_ANNOTATION_TYPE_REQUIRED_MEMBER_SUMMARY);
  ...
  public void addAnnotationDetailsTreeHeader(ClassDoc classDoc,
    ...
    if (!writer.printedAnnotationHeading) {
      memberDetailsTree.addContent(writer
          .getMarkerAnchor("annotation_type_element_detail"));
  ...
  public String getTableSummary() {
    return configuration().getText(
        ...
        configuration().getText(
            "doclet.Annotation_Type_Required_Member_Summary"),
  ...
  public void addSummaryAnchor(ClassDoc cd, Content memberTree) {
    memberTree.addContent(writer
        .getMarkerAnchor("annotation_type_required_element_summary"));
  }
  ...
  protected void addSummaryLink(int context, ClassDoc cd,
    ...
    Content strong = HtmlTree.STRONG(new RawHtml(writer.getDocLink(context,
  ...
  protected Content getDeprecatedLink(ProgramElementDoc member) {
    return writer.getDocLink(LinkInfoImpl.CONTEXT_MEMBER, (MemberDoc) member,
        ((MemberDoc) member).qualifiedName());
  }
