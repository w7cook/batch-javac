...
public class StringContent extends Content {
   ...
   *           this method will always throw a DocletAbortException because it
   *           is not supported.
   */
  ...
  /**
   * Adds content for the StringContent object. The method escapes HTML
   * characters for the string content that is added.
   * 
   * @param strContent
