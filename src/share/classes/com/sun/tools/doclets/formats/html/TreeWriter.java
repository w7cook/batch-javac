...
/**
 * Generate Class Hierarchy page for all the Classes in this run. Use ClassTree
 * for building the Tree. The name of the generated file is "overview-tree.html"
 * and it is generated in the current or the destination directory.
 * 
...
public class TreeWriter extends AbstractTreeWriter {
   ...
   */
  public TreeWriter(ConfigurationImpl configuration, String filename,
  ...
  /**
   * Create a TreeWriter object and use it to generate the "overview-tree.html"
   * file.
   * 
   * @param classtree
  ...
  protected void addPackageTreeLinks(Content contentTree) {
    ...
    if (!classesonly) {
      ...
      for (int i = 0; i < packages.length; i++) {
        ...
        Content li = HtmlTree.LI(getHyperLink(link, "", new StringContent(
            packages[i].name())));
