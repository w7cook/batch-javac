...
/**
 * Generate serialized form for serializable fields. Documentation denoted by
 * the tags <code>serial</code> and <code>serialField</code> is processed.
 * 
 * @author Joe Fialli
 * @author Bhavesh Patel (Modified)
 */
public class HtmlSerialFieldWriter extends FieldWriterImpl implements
   ...
   * 
   * @param isLastContent
   *          true if the cotent being documented is the last content.
   * @return a content tree for the header
   */
   ...
   *          the tree to be added to the serializable fileds content tree
  ...
  public Content getSerializableFields(String heading,
    ...
    if (serializableFieldsTree.isValid()) {
      ...
      Content serialHeading = HtmlTree.HEADING(
          HtmlConstants.SERIALIZED_MEMBER_HEADING, headingContent);
   ...
   * 
   * @param fieldsType
   *          the class document to be listed
   * @param fieldTypeStr
   *          the string for the filed type to be documented
   * @param fieldDimensions
   *          the dimensions of the field string to be added
   * @param firldName
  ...
  /**
   * Check to see if overview details should be printed. If nocomment option set
   * or if there is no text to be printed for deprecation info, comment or tags,
