 ...
 */
public class NestedClassWriterImpl extends AbstractMemberWriter implements
    MemberSummaryWriter {
  ...
  public void addInheritedSummaryAnchor(ClassDoc cd, Content inheritedTree) {
    inheritedTree.addContent(writer
        .getMarkerAnchor("nested_classes_inherited_from_class_"
            + cd.qualifiedName()));
  }
  ...
  public void addInheritedSummaryLabel(ClassDoc cd, Content inheritedTree) {
    ...
    Content label = new StringContent(cd.isInterface() ? configuration()
        .getText("doclet.Nested_Classes_Interface_Inherited_From_Interface")
  ...
  protected void addSummaryLink(int context, ClassDoc cd,
    ...
    Content strong = HtmlTree.STRONG(new RawHtml(writer
        .getLink(new LinkInfoImpl(context, (ClassDoc) member, false))));
  ...
  protected void addInheritedSummaryLink(ClassDoc cd, ProgramElementDoc member,
      Content linksTree) {
    linksTree.addContent(new RawHtml(writer.getLink(new LinkInfoImpl(
        LinkInfoImpl.CONTEXT_MEMBER, (ClassDoc) member, false))));
  }
  ...
  protected Content getNavSummaryLink(ClassDoc cd, boolean link) {
    if (link) {
      return writer.getHyperLink("", (cd == null) ? "nested_class_summary"
          : "nested_classes_inherited_from_class_" + cd.qualifiedName(), writer
          .getResource("doclet.navNested"));
    } else {
