...
/**
 * Class for the Html format code generation. Initilizes PrintWriter with
 * FileWriter, to enable print related methods to generate the code to the named
 * File through FileWriter.
 * 
 * @since 1.2
...
public class HtmlWriter extends PrintWriter {
   ...
   */
  public static final String fileseparator = DirectoryManager.URL_FILE_SEPARATOR;
   ...
   * 
   * @param path
   *          The directory path to be created for this file or null if none to
   *          be created.
   * @param filename
   ...
   *              next level.
   */
  public HtmlWriter(Configuration configuration, String path, String filename,
      String docencoding) throws IOException, UnsupportedEncodingException {
   ...
   * 
   * @param key
   *          the key to look for in the configuration file
   ...
   *          the key to look for in the configuration file
   * @param a1
   *          string argument added to configuration text
   * @return a content tree for the text
   */
  ...
  protected HtmlTree getWinTitleScript() {
    ...
    if (winTitle != null && winTitle.length() > 0) {
      ...
      String scriptCode = "<!--" + DocletConstants.NL
          ...
          + DocletConstants.NL + "        parent.document.title=\"" + winTitle
  ...
  protected Content getFramesetJavaScript() {
    ...
    String scriptCode = DocletConstants.NL
        ...
        + DocletConstants.NL + "        targetPage = targetPage.substring(1);"
        + DocletConstants.NL + "    if (targetPage.indexOf(\":\") != -1)"
        + DocletConstants.NL + "        targetPage = \"undefined\";"
        + DocletConstants.NL + "    function loadFrames() {"
        + DocletConstants.NL
        + "        if (targetPage != \"\" && targetPage != \"undefined\")"
        + DocletConstants.NL
  ...
  /**
   * Return the Javascript call to be embedded in the &lt;BODY&gt; tag. Return
   * nothing if winTitle is empty.
   * 
  ...
  /**
   * Print &lt;BODY BGCOLOR="bgcolor"&gt;, including JavaScript "onload" call to
   * load windowtitle script. This script shows the name of the document in the
   * window title bar when frames are on.
   * 
   * @param bgcolor
   *          Background color.
   * @param includeScript
   *          boolean set true if printing windowtitle script
   */
   ...
   * 
   * @param includeScript
   *          set true if printing windowtitle script
   * @param title
  ...
  public HtmlTree getBody(boolean includeScript, String title) {
    ...
    if (includeScript) {
      ...
      Content noScript = HtmlTree.NOSCRIPT(HtmlTree
          .DIV(getResource("doclet.No_Script_Message")));
  ...
  /**
   * Print text with &lt;H1&gt; tag. Also adds &lt;/H1&gt; tag. Add a newline
   * character at the end of the text.
   * 
   * @param text
   *          Text to be printed with &lt;H1&gt; format.
   */
  ...
  /**
   * Print text with &lt;H2&gt; tag. Also adds &lt;/H2&gt; tag. Add a newline
   * character at the end of the text.
   * 
   * @param text
   *          Text to be printed with &lt;H2&gt; format.
   */
  ...
  /**
   * Print text with &lt;H3&gt; tag. Also adds &lt;/H3&gt; tag. Add a newline
   * character at the end of the text.
   * 
   * @param text
   *          Text to be printed with &lt;H3&gt; format.
   */
  ...
  /**
   * Print text with &lt;H4&gt; tag. Also adds &lt;/H4&gt; tag. Add a newline
   * character at the end of the text.
   * 
   * @param text
   *          Text to be printed with &lt;H4&gt; format.
   */
  ...
  /**
   * Print HTML &lt;IMG SRC="imggif" WIDTH="width" HEIGHT="height"
   * ALT="imgname&gt; tag. It prepends the "images" directory name to the
   * "imggif". This method is used for oneone format generation. Add a newline
  ...
  public void img(String imggif, String imgname, int width, int height) {
    println("<IMG SRC=\"images/" + imggif + ".gif\"" + " WIDTH=\"" + width
        + "\" HEIGHT=\"" + height + "\" ALT=\"" + imgname + "\">");
  }
  ...
  /**
   * Print &lt;HR SIZE="size" NOSHADE&gt; tag. Add a newline character at the
   * end.
   * 
   * @param size
   *          Size of the ruler.
  ...
  /**
   * Print text passed, in strong format using &lt;STRONG&gt; and
   * &lt;/STRONG&gt; tags.
   * 
   * @param text
   *          String to be printed in between &lt;STRONG&gt; and &lt;/STRONG&gt;
   *          tags.
   */
   ...
   * 
   * @param text
   *          String to be printed in between &lt;I&gt; and &lt;/I&gt; tags.
   */
  ...
  /**
   * Return, text passed, with Italics &lt;i&gt; and &lt;/i&gt; tags,
   * surrounding it. So if the text passed is "Hi", then string returned will be
   * "&lt;i&gt;Hi&lt;/i&gt;".
   * 
   * @param text
   *          String to be printed in between &lt;I&gt; and &lt;/I&gt; tags.
  ...
  /**
   * Print &lt;FONT CLASS="stylename"&gt; tag. Add a newline character at the
   * end.
   * 
   * @param stylename
   *          String stylename.
  ...
  /**
   * Print &lt;FONT SIZE="size" CLASS="stylename"&gt; tag. Add a newline
   * character at the end.
   * 
   * @param size
   *          String size.
   ...
   *          Width of the table.
   * @param cellpadding
   *          Cellpadding for the table cells.
   * @param cellspacing
   *          Cellspacing for the table cells.
   */
  public void table(int border, String width, int cellpadding, int cellspacing) {
    println(DocletConstants.NL + "<TABLE BORDER=\"" + border + "\" WIDTH=\""
        + width + "\" CELLPADDING=\"" + cellpadding + "\" CELLSPACING=\""
        + cellspacing + "\" SUMMARY=\"\">");
  }

  /**
   * Print HTML &lt;TABLE BORDER="border" WIDTH="width"
   * CELLPADDING="cellpadding" CELLSPACING="cellspacing" SUMMARY="summary"&gt;
   * tag.
   * 
   * @param border
   *          Border size.
  ...
  public void table(int border, int cellpadding, int cellspacing) {
    println(DocletConstants.NL + "<TABLE BORDER=\"" + border
  ...
  /**
   * Print &lt;CAPTION CLASS="stylename"&gt; tag. Adds a newline character at
   * the end.
   * 
   * @param stylename
   *          style to be applied.
  ...
  /**
   * Print &lt;TR BGCOLOR="color" CLASS="stylename"&gt; tag. Adds a newline
   * character at the end.
   * 
   * @param color
   *          String color.
  ...
  /**
   * Print &lt;TR ALIGN="align" VALIGN="valign"&gt; tag. Adds a newline
   * character at the end.
   * 
   * @param align
   *          String align.
  ...
  public void tdAlignVAlignRowspan(String align, String valign, int rowspan) {
    print("<TD ALIGN=\"" + align + "\" VALIGN=\"" + valign + "\" ROWSPAN="
        + rowspan + ">");
  }
