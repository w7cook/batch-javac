 ...
 * used in the left-hand bottom frame, when "All Classes" link is clicked in the
 * left-hand top frame. The name of the generated file is
...
public class AllClassesFrameWriter extends HtmlDocletWriter {
  ...
  public static void generate(ConfigurationImpl configuration,
    ...
    try {
      allclassgen = new AllClassesFrameWriter(configuration, filename,
          indexbuilder);
   ...
   * 
   * @param content
   *          HtmlTree content to which all classes information will be added
   * @param wantFrames
   *          True if we want frames.
   */
  ...
  /**
   * Given a list of classes, generate links for each class or interface. If the
   * class kind is interface, print it in the italics font. Also all links
   * should target the right-hand frame. If clicked on any class name in this
   * page, appropriate class page should get opened in the right-hand frame.
   * 
   * @param classlist
