 ...
 */
public class EnumConstantWriterImpl extends AbstractMemberWriter implements
  ...
  public Content getEnumConstantsDetailsTreeHeader(ClassDoc classDoc,
    ...
    enumConstantsDetailsTree.addContent(writer
        .getMarkerAnchor("enum_constant_detail"));
  ...
  public Content getEnumConstantsTreeHeader(FieldDoc enumConstant,
    ...
    enumConstantsDetailsTree.addContent(writer.getMarkerAnchor(enumConstant
        .name()));
  ...
  public Content getSignature(FieldDoc enumConstant) {
    ...
    Content enumConstantLink = new RawHtml(writer.getLink(new LinkInfoImpl(
        LinkInfoImpl.CONTEXT_MEMBER, enumConstant.type())));
  ...
  public String[] getSummaryTableHeader(ProgramElementDoc member) {
    String[] header = new String[] { configuration().getText("doclet.0_and_1",
  ...
  protected Content getNavSummaryLink(ClassDoc cd, boolean link) {
    if (link) {
      return writer.getHyperLink("", (cd == null) ? "enum_constant_summary"
          : "enum_constants_inherited_from_class_"
              + configuration().getClassName(cd), writer
          .getResource("doclet.navEnum"));
    } else {
