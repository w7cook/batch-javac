...
public class HtmlTree extends Content {
   ...
   *          HTML tag for the HtmlTree object
   * @param contents
   *          contents to be added to the tree
   */
  ...
  /**
   * This method adds a string content to the htmltree. If the last content
   * member added is a StringContent, append the string to that StringContent or
   * else create a new StringContent and add it to the html tree.
   * 
   * @param stringContent
   ...
   * 
   * @param ref
   *          reference url for the anchor tag
   * @param body
   *          content for the anchor tag
  ...
  /**
   * Generates a DIV tag with the style class attributes. It also encloses a
   * content.
   * 
   * @param styleClass
   *          stylesheet class for the tag
   * @param body
   *          content for the tag
   ...
   * 
   * @param body
   *          content to be added to the tag
   ...
   * 
   * @param src
   *          the url of the document to be shown in the frame
   * @param name
   *          specifies the name of the frame
   * @param title
   *          the title for the frame
   * @param scrolling
   *          specifies whether to display scrollbars in the frame
   ...
   * 
   * @param cols
   *          the size of columns in the frameset
   * @param rows
   *          the size of rows in the frameset
   * @param title
   *          the title for the frameset
   * @param onload
   *          the script to run when the document loads
   * @return an HtmlTree object for the FRAMESET tag
   */
  public static HtmlTree FRAMESET(String cols, String rows, String title,
      String onload) {
  ...
  /**
   * Generates a heading tag (h1 to h6) with the title and style class
   * attributes. It also encloses a content.
   * 
   * @param headingTag
   *          the heading tag to be generated
   * @param printTitle
   *          true if title for the tag needs to be printed else false
   * @param styleClass
   *          stylesheet class for the tag
   * @param body
   *          content for the tag
  ...
  /**
   * Generates a heading tag (h1 to h6) with style class attribute. It also
   * encloses a content.
   * 
   * @param headingTag
   *          the heading tag to be generated
   ...
   * @return an HtmlTree object for the tag
   */
  public static HtmlTree HEADING(HtmlTag headingTag, HtmlStyle styleClass,
      Content body) {
    return HEADING(headingTag, false, styleClass, body);
  }

  /**
   * Generates a heading tag (h1 to h6) with the title attribute. It also
   * encloses a content.
   * 
   * @param headingTag
   *          the heading tag to be generated
   * @param printTitle
   *          true if the title for the tag needs to be printed else false
   * @param body
   *          content for the tag
   * @return an HtmlTree object for the tag
   */
   ...
   * 
   * @param lang
   *          language for the HTML document
   * @param head
   *          head for the HTML tag
   * @param body
   *          body for the HTML tag
   * @return an HtmlTree object for the HTML tag
   */
  public static HtmlTree HTML(String lang, Content head, Content body) {
    HtmlTree htmltree = new HtmlTree(HtmlTag.HTML, nullCheck(head),
        nullCheck(body));
   ...
   * 
   * @param http
   *          -equiv http equiv attribute for the META tag
   * @param content
   *          type of content
   * @param charset
   *          character set used
  ...
  /**
   * Generates a Table tag with border, width and summary attributes and some
   * content.
   * 
   * @param border
  ...
  /**
   * Generates a Table tag with style class, border, cell padding, cellspacing
   * and summary attributes and some content.
   * 
   * @param styleClass
   *          style of the table
   * @param border
   ...
   * @return an HtmlTree object for the TABLE tag
   */
  public static HtmlTree TABLE(HtmlStyle styleClass, int border,
      int cellPadding, int cellSpacing, String summary, Content body) {
    HtmlTree htmltree = new HtmlTree(HtmlTag.TABLE, nullCheck(body));
    if (styleClass != null)
      htmltree.addStyle(styleClass);
    htmltree.addAttr(HtmlAttr.BORDER, Integer.toString(border));
  ...
  /**
   * Generates a Table tag with border, cell padding, cellspacing and summary
   ...
   * @return an HtmlTree object for the TABLE tag
   */
  public static HtmlTree TABLE(int border, int cellPadding, int cellSpacing,
      String summary, Content body) {
   ...
   * 
   * @param attrName
   *          name of the attribute to check within the HTML tree
