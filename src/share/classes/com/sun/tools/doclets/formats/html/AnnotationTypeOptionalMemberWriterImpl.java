...
public class AnnotationTypeOptionalMemberWriterImpl extends
    AnnotationTypeRequiredMemberWriterImpl implements
    AnnotationTypeOptionalMemberWriter, MemberSummaryWriter {
  ...
  public Content getMemberSummaryHeader(ClassDoc classDoc,
    ...
    memberSummaryTree
        .addContent(HtmlConstants.START_OF_ANNOTATION_TYPE_OPTIONAL_MEMBER_SUMMARY);
  ...
  public String getTableSummary() {
    return configuration().getText(
        ...
        configuration().getText(
            "doclet.Annotation_Type_Optional_Member_Summary"),
  ...
  public void addSummaryAnchor(ClassDoc cd, Content memberTree) {
    memberTree.addContent(writer
        .getMarkerAnchor("annotation_type_optional_element_summary"));
  }
