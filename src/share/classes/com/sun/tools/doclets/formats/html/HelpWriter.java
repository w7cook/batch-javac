...
public class HelpWriter extends HtmlDocletWriter {
   ...
   * The name of the generated file is "help-doc.html". The help file will get
   * generated if and only if "-helpfile" and "-nohelp" is not used on the
   * command line.
   * 
  ...
  /**
   * Add the help file contents from the resource file to the content tree.
   * While adding the help file contents it also keeps track of user options. If
   * "-notree" is used, then the "overview-tree.html" will not get added and
   * hence help information also will not get added.
   * 
   * @param contentTree
   *          the content tree to which the help file contents will be added
   */
  protected void addHelpFileContents(Content contentTree) {
    Content heading = HtmlTree.HEADING(HtmlConstants.TITLE_HEADING, false,
        HtmlStyle.title, getResource("doclet.Help_line_1"));
    ...
    aul.addContent(HtmlTree
        .LI(getResource("doclet.Help_annotation_type_line_2")));
    aul.addContent(HtmlTree
        .LI(getResource("doclet.Help_annotation_type_line_3")));
    aul.addContent(HtmlTree
        .LI(getResource("doclet.Annotation_Type_Required_Member_Summary")));
    aul.addContent(HtmlTree
        .LI(getResource("doclet.Annotation_Type_Optional_Member_Summary")));
    aul.addContent(HtmlTree
        .LI(getResource("doclet.Annotation_Type_Member_Detail")));
