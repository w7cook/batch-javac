...
public class HtmlSerialMethodWriter extends MethodWriterImpl implements
   ...
   * @param serializableMethodContent
   *          the tree to be added to the serializable methods content tree
   * @return a content tree for the serializable methods content
   */
  public Content getSerializableMethods(String heading,
      Content serializableMethodContent) {
    Content li = HtmlTree.LI(HtmlStyle.blockList,
        writer.getMarkerAnchor("serialized_methods"));
   ...
   * 
   * @param member
   *          the method document to be listed
  ...
  public void addMemberHeader(MethodDoc member, Content methodsContentTree) {
    methodsContentTree.addContent(writer.getMarkerAnchor(writer
        .getAnchor(member)));
  ...
  public void addMemberTags(MethodDoc member, Content methodsContentTree) {
    ...
    if (method.name().compareTo("writeExternal") == 0
      ...
      serialWarning(member.position(), "doclet.MissingSerialDataTag", method
