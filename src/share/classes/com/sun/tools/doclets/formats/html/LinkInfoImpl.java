...
public class LinkInfoImpl extends LinkInfo {
   ...
   *          String style of text defined in style sheet.
   */
  public LinkInfoImpl(int context, ClassDoc classDoc, String where,
      String label, boolean isStrong, String styleName) {
    this.classDoc = classDoc;
    this.where = where;
    this.label = label;
   ...
   *          the class to link to.
   * @param isVarArg
   *          true if this is a link to a var arg.
   */
   ...
   *          true if the link should be strong.
   */
  public LinkInfoImpl(int context, Type type, String label, boolean isStrong) {
    this.type = type;
    this.label = label;
    this.isStrong = isStrong;
    setContext(context);
   ...
   * {@inheritDoc}
   * 
   * This method sets the link attributes to the appropriate values based on the
   * context.
   * 
   * @param c
  ...
  public void setContext(int c) {
    ...
    context = c;
    if (type != null && type.asTypeVariable() != null
