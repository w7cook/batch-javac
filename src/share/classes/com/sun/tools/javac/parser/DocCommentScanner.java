...
public class DocCommentScanner extends Scanner {
  ...
  private void expandCommentBuffer() {
    ...
    System
        .arraycopy(docCommentBuffer, 0, newBuffer, 0, docCommentBuffer.length);
  ...
  /**
   * Read next character in doc comment, skipping over double '\' characters. If
   * a double '\' is skipped, put in the buffer and update buffer count.
   */
  ...
  /**
   * Process a doc comment and make the string content available. Strips leading
