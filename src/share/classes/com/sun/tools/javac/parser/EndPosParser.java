...
public class EndPosParser extends JavacParser {
  ...
  public EndPosParser(ParserFactory fac, Lexer S, boolean keepDocComments,
      boolean keepLineMap) {
  ...
  /**
   * A hashtable to store ending positions of source ranges indexed by the tree
   * nodes. Defined only if option flag genEndPos is set.
   */
