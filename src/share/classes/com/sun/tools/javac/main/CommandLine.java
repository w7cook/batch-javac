...
public class CommandLine {
   ...
   * and return the resulting arguments. A command file argument is of the form
   * '@file' where 'file' is the name of the file whose contents are to be
   * parsed for additional arguments. The contents of the command file are
   * parsed using StreamTokenizer and the original '@file' argument replaced
   * with the resulting tokens. Recursive command files are not supported. The
