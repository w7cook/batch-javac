...
public interface JavacOption {
   ...
   * 
   * @param options
   *          the accumulated set of analyzed options
   * @param option
   *          the option to be processed
   * @param arg
   *          the arg for the option to be processed
  ...
  static class Option implements JavacOption {
    ...
    /**
     * The choices for this option, if any, and whether or not the choices are
     * hidden
     */
     ...
     * 
     * @param out
     *          the stream to which to write the documentation
     */
    ...
    public boolean process(Options options, String option) {
      if (hasSuffix)
        return process(options, name.optionName,
            option.substring(name.optionName.length()));
      else
  ...
  static class XOption extends Option {
    ...
    XOption(OptionName name, String descrKey, ChoiceKind kind,
        String... choices) {
