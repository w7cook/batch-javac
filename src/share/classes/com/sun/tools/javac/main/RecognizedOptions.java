...
public class RecognizedOptions {
  ...
  static Set<OptionName> javacOptions = EnumSet.of(CIVET, G, G_NONE, G_CUSTOM,
      XLINT, XLINT_CUSTOM, NOWARN, VERBOSE, DEPRECATION, CLASSPATH, CP,
      SOURCEPATH, BOOTCLASSPATH, XBOOTCLASSPATH_PREPEND, XBOOTCLASSPATH_APPEND,
      XBOOTCLASSPATH, EXTDIRS, DJAVA_EXT_DIRS, ENDORSEDDIRS,
      DJAVA_ENDORSED_DIRS, PROC, PROCESSOR, PROCESSORPATH, D, S, IMPLICIT,
      ENCODING, SOURCE, TARGET, VERSION, FULLVERSION, DIAGS, HELP, A, X, J,
      MOREINFO,
      WERROR,
      // COMPLEXINFERENCE,
      PROMPT, DOE, PRINTSOURCE, WARNUNCHECKED, XMAXERRS, XMAXWARNS, XSTDOUT,
      XPKGINFO, XPRINT, XPRINTROUNDS, XPRINTPROCESSORINFO, XPREFER, O, XJCOV,
      XD, AT, SOURCEFILE);

  static Set<OptionName> javacFileManagerOptions = EnumSet.of(CLASSPATH, CP,
      SOURCEPATH, BOOTCLASSPATH, XBOOTCLASSPATH_PREPEND, XBOOTCLASSPATH_APPEND,
      XBOOTCLASSPATH, EXTDIRS, DJAVA_EXT_DIRS, ENDORSEDDIRS,
      DJAVA_ENDORSED_DIRS, PROCESSORPATH, D, S, ENCODING, SOURCE);

  static Set<OptionName> javacToolOptions = EnumSet.of(CIVET, G, G_NONE,
      G_CUSTOM, XLINT, XLINT_CUSTOM, NOWARN, VERBOSE, DEPRECATION, PROC,
      PROCESSOR,
      IMPLICIT,
      SOURCE,
      TARGET,
      ...
      MOREINFO, WERROR,
      // COMPLEXINFERENCE,
      PROMPT, DOE, PRINTSOURCE, WARNUNCHECKED, XMAXERRS, XMAXWARNS,
      // XSTDOUT,
      XPKGINFO, XPRINT, XPRINTROUNDS, XPRINTPROCESSORINFO, XPREFER, O, XJCOV,
      XD);
   ...
   * 
   * @param helper
   *          an {@code OptionHelper} to help when processing options
  ...
  public static Option[] getAll(final OptionHelper helper) {
    return new Option[] {
        ...
        new XOption(XBOOTCLASSPATH_PREPEND, "opt.arg.path",
            "opt.Xbootclasspath.p"),
        new XOption(XBOOTCLASSPATH_APPEND, "opt.arg.path",
            "opt.Xbootclasspath.a"),
        ...
        new Option(PROC, "opt.proc.none.only", Option.ChoiceKind.ONEOF, "none",
            "only"),
        ...
        new Option(IMPLICIT, "opt.implicit", Option.ChoiceKind.ONEOF, "none",
            "class"),
        ...
        new HiddenOption(DIAGS) {
          ...
          public boolean process(Options options, String option) {
            ...
            String diagsOption = option.contains("%") ? "-XDdiagsFormat="
                : "-XDdiags=";
            diagsOption += option;
        ...
        new Option(A, "opt.arg.key.equals.value", "opt.A") {
          ...
          public boolean process(Options options, String option) {
            ...
            String key = option.substring(2, (sepIndex != -1 ? sepIndex
                : argLength));
        ...
        new XOption(XPREFER, "opt.prefer", Option.ChoiceKind.ONEOF, "source",
            "newer"),

        new XOption(XPKGINFO, "opt.pkginfo", Option.ChoiceKind.ONEOF, "always",
            "legacy", "nonempty"),
        ...
        /*
         * This is a back door to the compiler's option table. -XDx=y sets the
         * option x to the value y. -XDx sets the option x to the value x.
         */
        new HiddenOption(XD) {
          String s;
        ...
        /*
         * TODO: With apt, the matches method accepts anything if -XclassAsDecls
         * is used; code elsewhere does the lookup to see if the class name is
         * both legal and found.
         * 
         * In apt, the process method adds the candidate class file name to a
         * separate list.
         */
  ...
  public enum PkgInfo {
    ...
    public static PkgInfo get(Options options) {
      ...
      return (v == null ? PkgInfo.LEGACY : PkgInfo.valueOf(v.toUpperCase()));
    }
  }
