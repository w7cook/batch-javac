...
public class TreeMaker implements JCTree.Factory {
  ...
  public JCMethodDecl MethodDef(JCModifiers mods, Name name,
    ...
    JCMethodDecl tree = new JCMethodDecl(mods, name, restype, typarams, params,
  ...
  public JCTry Try(List<JCTree> resources, JCBlock body,
  ...
  public JCMethodInvocation Apply(List<JCExpression> typeargs, JCExpression fn,
  ...
  public JCExpression QualIdent(Symbol sym) {
    return isUnqualifiable(sym) ? Ident(sym)
  ...
  public JCVariableDecl VarDef(VarSymbol v, JCExpression init) {
    return (JCVariableDecl) new JCVariableDecl(Modifiers(v.flags(),
        Annotations(v.getAnnotationMirrors())), v.name, Type(v.type), init, v)
  ...
  public JCLiteral Literal(Object value) {
    ...
    if (value instanceof String) {
      ...
      result = Literal(CHAR, value).setType(syms.charType.constType(v));
      ...
      return Literal(TypeTags.BOT, null).setType(syms.objectType);
    } else {
  ...
  public JCMethodDecl MethodDef(MethodSymbol m, Type mtype, JCBlock body) {
    return (JCMethodDecl) new JCMethodDecl(Modifiers(m.flags(),
        ...
        Params(mtype.getParameterTypes(), m), Types(mtype.getThrownTypes()),
        body, null, m).setPos(pos).setType(mtype);
  }
  ...
  public JCTypeParameter TypeParam(Name name, TypeVar tvar) {
    return (JCTypeParameter) TypeParameter(name, Types(types.getBounds(tvar)))
        .setPos(pos).setType(tvar);
  }
