...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
   ...
   * @param docComments
   *          A hashtable that stores all documentation comments indexed by the
   *          tree nodes they refer to. defined only if option -s is set.
   * @param endPositions
   *          A hashtable that stores ending positions of source ranges indexed
   *          by the tree nodes they belong to. Defined only if option -Xjcov is
   *          set.
   */
  public static class JCCompilationUnit extends JCTree implements
    ...
    protected JCCompilationUnit(List<JCAnnotation> packageAnnotations,
        ...
        PackageSymbol packge, ImportScope namedImportScope,
  ...
  public static class JCVariableDecl extends JCStatement implements
    ...
    protected JCVariableDecl(JCModifiers mods, Name name, JCExpression vartype,
  ...
  public static class JCTry extends JCStatement implements TryTree {
    ...
    protected JCTry(List<JCTree> resources, JCBlock body,
        List<JCCatch> catchers, JCBlock finalizer) {
      this.body = body;
  ...
  public interface Factory {
    ...
    JCMethodDecl MethodDef(JCModifiers mods, Name name, JCExpression restype,
        List<JCTypeParameter> typarams, List<JCVariableDecl> params,
        List<JCExpression> thrown, JCBlock body, JCExpression defaultValue);

    JCVariableDecl VarDef(JCModifiers mods, Name name, JCExpression vartype,
        JCExpression init);
    ...
    JCTry Try(List<JCTree> resources, JCBlock body, List<JCCatch> catchers,
        JCBlock finalizer);
