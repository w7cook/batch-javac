...
public class TreeInfo {
  ...
  /**
   * The end position of given tree, given a table of end positions generated by
   * the parser
   */
  ...
  /**
   * A DiagnosticPosition with the preferred position set to the end position of
   * given tree, if it is a block with defined endpos.
   */
  ...
  /**
   * Find the position for reporting an error about a symbol, where that symbol
   * is defined somewhere in the given tree.
   */
  ...
  /**
   * If this tree is a declaration or a block, return its flags field, otherwise
   * return 0.
   */
  ...
  public static final int notExpression = -1, // not an expression
      ...
      assignPrec = 1, assignopPrec = 2, condPrec = 3, orPrec = 4,
      andPrec = 5,
      bitorPrec = 6, bitxorPrec = 7, bitandPrec = 8, eqPrec = 9,
      ordPrec = 10,
      shiftPrec = 11, addPrec = 12, mulPrec = 13,
      prefixPrec = 14,
  ...
  /**
   * Returns the underlying type of the tree if it is annotated type, or the
   * tree itself otherwise
   */
