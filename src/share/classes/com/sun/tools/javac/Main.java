 ...
 * 
 * <p>
 * Except for the two methods {@link #compile(java.lang.String[])}
 * {@link #compile(java.lang.String[],java.io.PrintWriter)}, nothing described
 * in this source file is part of any supported API. If you write code that
 * depends on this, you do so at your own risk. This code and its internal
...
public class Main {
   ...
   * 
   * @param args
   *          The command line arguments that would normally be passed to the
   *          javac program as described in the man page.
   * @return an integer equivalent to the exit value from invoking javac, see
   *         the man page for details.
   */
  public static int compile(String[] args) {
    com.sun.tools.javac.main.Main compiler = new com.sun.tools.javac.main.Main(
        "javac");
   ...
   *          javac program as described in the man page.
   * @param out
   *          PrintWriter to which the compiler's diagnostic output is directed.
   * @return an integer equivalent to the exit value from invoking javac, see
   *         the man page for details.
   */
