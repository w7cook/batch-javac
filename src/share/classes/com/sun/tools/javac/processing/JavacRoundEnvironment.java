 ...
 * 
 * <p>
 * The methods in this class do not take type annotations into account, as
 * target types, not java elements.
 * 
 * <p>
...
public class JavacRoundEnvironment implements RoundEnvironment {
  ...
  JavacRoundEnvironment(boolean processingOver, boolean errorRaised,
      Set<? extends Element> rootElements, ProcessingEnvironment processingEnv) {
  ...
  public String toString() {
    return String.format(
        "[errorRaised=%b, rootElements=%s, processingOver=%b]", errorRaised,
        rootElements, processingOver);
  }
   ...
   * 
   * @return the types elements specified by the prior round, or an empty set if
   *         there were none
   */
   ...
   * {@linkplain #getSpecifiedTypeElements specified types} and any types nested
   * within them.
   * 
   * @param a
  ...
  public Set<? extends Element> getElementsAnnotatedWith(TypeElement a) {
    ...
    ElementScanner7<Set<Element>, DeclaredType> scanner = new AnnotationSetScanner(
        result, typeUtil);
