...
public class Items {
   ...
   *          The represented symbol.
   * @param nonvirtual
   *          Is the reference not virtual? (true for constructors and private
   *          members).
   */
      ...
      if (typecode == targetcode) {
        ...
        case INTcode:
          if (Code.truncate(typecode) == INTcode)
            ...
            return new ImmediateItem(syms.intType, ((Number) value).intValue());
        case LONGcode:
  ...
  class CondItem extends Item {
    ...
    /*
     * An abstract syntax tree of this item. It is needed for branch entries in
     * 'CharacterRangeTable' attribute.
     */
    JCTree tree;
