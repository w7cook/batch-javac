...
public class Kinds {
  ...
  public enum KindName implements Formattable {
    ANNOTATION("kindname.annotation"), CONSTRUCTOR("kindname.constructor"), INTERFACE(
        "kindname.interface"), ENUM("kindname.enum"), STATIC("kindname.static"), TYPEVAR(
        "kindname.type.variable"), BOUND("kindname.type.variable.bound"), VAR(
        "kindname.variable"), VAL("kindname.value"), METHOD("kindname.method"), CLASS(
        "kindname.class"), PACKAGE("kindname.package");
  ...
  public static KindName typeKindName(Type t) {
    if (t.tag == TYPEVAR || t.tag == CLASS && (t.tsym.flags() & COMPOUND) != 0)
  ...
  /**
   * A KindName representing the kind of a a missing symbol, given an error
   * kind.
   * */
