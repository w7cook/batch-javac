...
public abstract class Attribute implements AnnotationValue {
  ...
  /**
   * The value for an annotation element of type java.lang.Class, represented as
   * a ClassSymbol.
   */
  ...
  public static class Compound extends Attribute implements AnnotationMirror {
    /**
     * The attributes values, as pairs. Each pair contains a reference to the
     * accessing method in the attribute interface and the value to be returned
     * when that method is called to access this attribute.
     */
    ...
    /**
     * Returns a string representation of this annotation. String is of one of
     * the forms:
     * 
     * @com.example.foo(name1=val1, name2=val2)
     * @com.example.foo(val)
     * @com.example.foo Omit parens for marker annotations, and omit "value="
     *                  when allowed.
     */
    public String toString() {
