...
public enum TargetType {
  ...
  /**
   * For annotations on a type argument or nested array of a method return type.
   */
   ...
   */
  CLASS_TYPE_PARAMETER_BOUND_GENERIC_OR_ARRAY(0x11, HasBound, HasLocation,
      HasParameter),
   ...
   */
  METHOD_TYPE_PARAMETER_BOUND_GENERIC_OR_ARRAY(0x13, HasBound, HasLocation,
      HasParameter),
  ...
  NEW_TYPE_ARGUMENT(0x18, IsLocal), NEW_TYPE_ARGUMENT_GENERIC_OR_ARRAY(0x19,
      HasLocation, IsLocal),

  METHOD_TYPE_ARGUMENT(0x1A, IsLocal), METHOD_TYPE_ARGUMENT_GENERIC_OR_ARRAY(
      0x1B, HasLocation, IsLocal),

  WILDCARD_BOUND(0x1C, HasBound), WILDCARD_BOUND_GENERIC_OR_ARRAY(0x1D,
      HasBound, HasLocation),

  CLASS_LITERAL(0x1E, IsLocal), CLASS_LITERAL_GENERIC_OR_ARRAY(0x1F,
      HasLocation, IsLocal),

  METHOD_TYPE_PARAMETER(0x20, HasParameter),

  // invalid location
  // @Deprecated METHOD_TYPE_PARAMETER_GENERIC_OR_ARRAY(0x21, HasLocation,
  // HasParameter),

  CLASS_TYPE_PARAMETER(0x22, HasParameter),

  // invalid location
  // @Deprecated CLASS_TYPE_PARAMETER_GENERIC_OR_ARRAY(0x23, HasLocation,
  // HasParameter),
  ...
  TargetType(int targetTypeValue, TargetAttribute... attributes) {
    if (targetTypeValue < Byte.MIN_VALUE || targetTypeValue > Byte.MAX_VALUE)
      throw new AssertionError("attribute type value needs to be a byte: "
          + targetTypeValue);
   ...
   * 
   * @return true if this TargetType represents an annotation on an inner type,
   *         false otherwise
   */
   ...
   * 
   * @return true if this TargetType has a parameter index, false otherwise
   */
   ...
   * 
   * Note: wildcard bound targets could target a local tree and a class member
   * declaration signature tree
   */
