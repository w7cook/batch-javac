 ...
 * formatting needs (e.g. where toString() does not apply because of
 * localization).
 * 
 * <p>
...
public interface Formattable {
  ...
  /**
   * Used to obtain a localized String representing the object accordingly to a
   * given locale
   * 
   * @param locale
   *          locale in which the object's representation is to be rendered
   * @param messages
   *          messages object used for localization
