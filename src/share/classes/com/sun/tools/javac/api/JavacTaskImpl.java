...
public class JavacTaskImpl extends JavacTask {
  ...
  JavacTaskImpl(Main compilerMain, String[] args, Context context,
  ...
  JavacTaskImpl(Main compilerMain, Iterable<String> flags, Context context,
      Iterable<String> classes, Iterable<? extends JavaFileObject> fileObjects) {
  ...
  static private List<JavaFileObject> toList(
   ...
   * 
   * <p>
   * <b>TODO: this method is useless here</b>
   * </p>
   * 
   * @param file
   *          a file
  ...
  public Iterable<? extends TypeElement> enter(
      Iterable<? extends CompilationUnitTree> trees) throws IOException {
    prepareCompiler();
  ...
  /**
   * Complete all analysis on the given classes. This can be used to ensure that
   * all compile time errors are reported. The classes must have previously been
   * returned from {@link #enter}. If null is specified, all outstanding classes
   * will be analyzed.
   * 
   * @param classes
  ...
  public Iterable<? extends Element> analyze(
      Iterable<? extends TypeElement> classes) throws IOException {
    enter(null); // ensure all classes have been entered

    final ListBuffer<Element> results = new ListBuffer<Element>();
    try {
      if (classes == null) {
        handleFlowResults(compiler.flow(compiler.attribute(compiler.todo)),
            results);
      } else {
        Filter f = new Filter() {
   ...
   * generated. If null is specified, code will be generated for all outstanding
   * classes.
   * 
   * @param classes
   *          a list of class elements
  ...
  abstract class Filter {
    void run(Queue<Env<AttrContext>> list,
        Iterable<? extends TypeElement> classes) {
  ...
  public Type parseType(String expr, TypeElement scope) {
    ...
    try {
      CharBuffer buf = CharBuffer.wrap((expr + "\u0000").toCharArray(), 0,
          expr.length());
