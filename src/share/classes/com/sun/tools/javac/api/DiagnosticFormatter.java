...
public interface DiagnosticFormatter<D extends Diagnostic<?>> {
   ...
   * @return true if the source line this diagnostic refers to is to be
   *         displayed
   */
  ...
  // where
  /**
   * This enum defines a set of constants for all the kinds of position that a
   * diagnostic can be asked for. All positions are intended to be relative to a
   * given diagnostic source.
   */
  ...
  interface Configuration {
    /**
     * Configure the set of diagnostic parts that should be displayed by the
     * formatter.
     * 
     * @param options
     *          options to set
    ...
    /**
     * Retrieve the set of diagnostic parts that should be displayed by the
     * formatter.
     * 
     * @return verbosity options
     */
     ...
     * might/might not be displayed by the formatter, according to the current
    ...
    public enum DiagnosticPart {
      ...
      SUMMARY,
      /**
       * Longer description that provides additional details w.r.t. the ones in
       * the diagnostic's description.
       */
      DETAILS,
      /**
    ...
    /**
     * Set a limit for multiline diagnostics. Note: Setting a limit has no
     * effect if multiline diagnostics are either fully enabled or disabled.
     * 
     * @param limit
    ...
    // where
    /**
     * A multiline limit control the verbosity of multiline diagnostics either
     * by setting a maximum depth of nested multidiagnostics, or by limiting the
     * amount of subdiagnostics attached to a given diagnostic (or both).
     */
    public enum MultilineLimit {
      ...
      DEPTH,
      /**
       * Controls the maximum amount of subdiagnostics that are part of a given
