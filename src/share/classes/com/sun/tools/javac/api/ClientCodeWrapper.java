 ...
 * <ul>
 * <li>Checked exceptions are left alone and propogate upwards in the obvious
 * way, since they are an expected aspect of the method's specification.
 ...
 * <li>All other unchecked exceptions (i.e. subtypes of RuntimeException and
 * Error) and caught, and rethrown as a ClientCodeException with its cause set
...
public class ClientCodeWrapper {
  ...
  /**
   * A map to cache the results of whether or not a specific classes can be
   * "trusted", and thus does not need to be wrapped.
   */
  ...
  public Iterable<JavaFileObject> wrapJavaFileObjects(
  ...
  protected class WrappedJavaFileManager implements JavaFileManager {
    ...
    public Iterable<JavaFileObject> list(Location location, String packageName,
      ...
      try {
        return wrapJavaFileObjects(clientJavaFileManager.list(location,
    ...
    public JavaFileObject getJavaFileForInput(Location location,
      ...
      try {
        return wrap(clientJavaFileManager.getJavaFileForInput(location,
            className, kind));
      } catch (ClientCodeException e) {
        throw e;
      } catch (RuntimeException e) {
    ...
    public JavaFileObject getJavaFileForOutput(Location location,
      ...
      try {
        return wrap(clientJavaFileManager.getJavaFileForOutput(location,
            className, kind, unwrap(sibling)));
      } catch (ClientCodeException e) {
        throw e;
      } catch (RuntimeException e) {
        throw new ClientCodeException(e);
    ...
    public FileObject getFileForInput(Location location, String packageName,
      ...
      try {
        return wrap(clientJavaFileManager.getFileForInput(location,
    ...
    public FileObject getFileForOutput(Location location, String packageName,
      ...
      try {
        return wrap(clientJavaFileManager.getFileForOutput(location,
            packageName, relativeName, unwrap(sibling)));
      } catch (ClientCodeException e) {
        throw e;
      } catch (RuntimeException e) {
        throw new ClientCodeException(e);
  ...
  protected class WrappedJavaFileObject extends WrappedFileObject implements
      JavaFileObject {
    ...
    public boolean isNameCompatible(String simpleName, Kind kind) {
      try {
        return ((JavaFileObject) clientFileObject).isNameCompatible(simpleName,
            kind);
      } catch (ClientCodeException e) {
        throw e;
      } catch (RuntimeException e) {
