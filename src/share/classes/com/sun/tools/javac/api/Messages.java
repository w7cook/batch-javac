...
public interface Messages {
  ...
  /**
   * Add a new resource bundle to the list that is searched for localized
   * messages.
   * 
   * @param bundleName
   *          the name to identify the resource bundle of localized messages.
   ...
   * 
   * @param l
   *          locale in which the text is to be localized
   * @param key
   *          locale-independent message key
   * @param args
   *          misc message arguments
