...
public class Convert {
   ...
   * Leaves non-ASCII characters alone.
   */
  public static String quote(char ch) {
    ...
    case '\\':
      return "\\\\";
    default:
      return (isPrintableAscii(ch)) ? String.valueOf(ch) : String.format(
          "\\u%04x", (int) ch);
    }
  }
  ...
  /**
   * Return the package name of a class name, excluding the trailing '.', "" if
   * not existent.
   */
