...
public class JCDiagnostic implements Diagnostic<JavaFileObject> {
  ...
  public static class Factory {
     ...
     * 
     * @param source
     *          The source of the compilation unit, if any, in which to report
     *          the error.
     * @param pos
     ...
     */
    public JCDiagnostic error(DiagnosticSource source, DiagnosticPosition pos,
    ...
    public JCDiagnostic mandatoryWarning(DiagnosticSource source,
      ...
      return create(WARNING, null, EnumSet.of(DiagnosticFlag.MANDATORY),
          source, pos, key, args);
    }
     ...
     * @see MandatoryWarningHandler
     */
    public JCDiagnostic mandatoryWarning(LintCategory lc,
        DiagnosticSource source, DiagnosticPosition pos, String key,
        Object... args) {
      return create(WARNING, lc, EnumSet.of(DiagnosticFlag.MANDATORY), source,
          pos, key, args);
    }
    ...
    public JCDiagnostic warning(LintCategory lc, String key, Object... args) {
      return create(WARNING, lc, EnumSet.noneOf(DiagnosticFlag.class), null,
          null, key, args);
    }
    ...
    public JCDiagnostic warning(DiagnosticSource source,
        DiagnosticPosition pos, String key, Object... args) {
      return create(WARNING, null, EnumSet.noneOf(DiagnosticFlag.class),
          source, pos, key, args);
    }
     ...
     * @see MandatoryWarningHandler
     */
    public JCDiagnostic warning(LintCategory lc, DiagnosticSource source,
        DiagnosticPosition pos, String key, Object... args) {
      return create(WARNING, lc, EnumSet.noneOf(DiagnosticFlag.class), source,
          pos, key, args);
    }
    ...
    public JCDiagnostic mandatoryNote(DiagnosticSource source, String key,
        Object... args) {
      return create(NOTE, null, EnumSet.of(DiagnosticFlag.MANDATORY), source,
          null, key, args);
    }
    ...
    public JCDiagnostic note(String key, Object... args) {
      return create(NOTE, null, EnumSet.noneOf(DiagnosticFlag.class), null,
          null, key, args);
    }
     ...
     *          Fields of the message.
     */
    public JCDiagnostic note(DiagnosticSource source, DiagnosticPosition pos,
        String key, Object... args) {
      return create(NOTE, null, EnumSet.noneOf(DiagnosticFlag.class), source,
          pos, key, args);
    }
    ...
    public JCDiagnostic fragment(String key, Object... args) {
      return create(FRAGMENT, null, EnumSet.noneOf(DiagnosticFlag.class), null,
          null, key, args);
    }

    /**
     * Create a new diagnostic of the given kind, which is not mandatory and
     * which has no lint category.
     * 
     * @param kind
     *          The diagnostic kind
     * @param ls
     *          The lint category, if applicable, or null
     * @param source
     *          The source of the compilation unit, if any, in which to report
     *          the message.
     * @param pos
     ...
     *          Fields of the message.
     */
    public JCDiagnostic create(DiagnosticType kind, DiagnosticSource source,
        DiagnosticPosition pos, String key, Object... args) {
      return create(kind, null, EnumSet.noneOf(DiagnosticFlag.class), source,
          pos, key, args);
    }
     ...
     *          Fields of the message.
     */
    public JCDiagnostic create(DiagnosticType kind, LintCategory lc,
        Set<DiagnosticFlag> flags, DiagnosticSource source,
        DiagnosticPosition pos, String key, Object... args) {
      return new JCDiagnostic(formatter, kind, lc, flags, source, pos, qualify(
          kind, key), args);
    }
  ...
  public static JCDiagnostic fragment(String key, Object... args) {
    return new JCDiagnostic(getFragmentFormatter(), FRAGMENT, null,
        EnumSet.noneOf(DiagnosticFlag.class), null, null, "compiler."
            + FRAGMENT.key + "." + key, args);
  }
  ...
  public static DiagnosticFormatter<JCDiagnostic> getFragmentFormatter() {
    if (fragmentFormatter == null) {
      fragmentFormatter = new BasicDiagnosticFormatter(
          JavacMessages.getDefaultMessages());
    }
  ...
  public enum DiagnosticType {
     ...
     * 
     * @param key
     *          A string used to create the resource key for the diagnostic.
     */
  ...
  public static interface DiagnosticPosition {
    ...
    /**
     * If there is a tree node, and if endPositions are available, get the end
     * position of the tree node. Otherwise, just returns the same as
  ...
  /**
   * A DiagnosticPosition that simply identifies a position, but no related tree
   * node, as the location for a diagnostic. Used for scanner and parser
   * diagnostics.
   */
  ...
  public enum DiagnosticFlag {
    MANDATORY, RESOLVE_ERROR, SYNTAX, RECOVERABLE
  }
   ...
   * 
   * @param fomatter
   *          the formatter to use for the diagnostic
   * @param dt
  ...
  protected JCDiagnostic(DiagnosticFormatter<JCDiagnostic> formatter,
      DiagnosticType dt, LintCategory lc, Set<DiagnosticFlag> flags,
      DiagnosticSource source, DiagnosticPosition pos, String key,
      Object... args) {
   ...
   * 
   * @return the name of the source referred to with this diagnostic, or null if
   *         none
   */
  ...
  protected int getIntEndPosition() {
    return (position == null ? Position.NOPOS : position.getEndPosition(source
        .getEndPosTable()));
  }
  ...
  public Diagnostic.Kind getKind() {
    ...
    case WARNING:
      return flags.contains(DiagnosticFlag.MANDATORY) ? Diagnostic.Kind.MANDATORY_WARNING
  ...
  public static class MultilineDiagnostic extends JCDiagnostic {
    ...
    public MultilineDiagnostic(JCDiagnostic other,
        List<JCDiagnostic> subdiagnostics) {
      super(other.defaultFormatter, other.getType(), other.getLintCategory(),
          other.flags, other.getDiagnosticSource(), other.position, other
              .getCode(), other.getArgs());
