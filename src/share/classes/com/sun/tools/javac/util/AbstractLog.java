...
/**
 * A base class for error logs. Reports errors and warnings, and keeps track of
 * error numbers and positions.
 * 
 * <p>
...
public abstract class AbstractLog {
   ...
   *          Fields of the warning message.
   */
  public void warning(LintCategory lc, DiagnosticPosition pos, String key,
      Object... args) {
   ...
   *          Fields of the warning message.
   */
  public void mandatoryWarning(DiagnosticPosition pos, String key,
      Object... args) {
   ...
   *          Fields of the warning message.
   */
  public void mandatoryWarning(LintCategory lc, DiagnosticPosition pos,
   ...
   * @param args
   *          Fields of the notint an error or warning message:
   */
   ...
   *          The key for the localized notification message.
   * @param args
   *          Fields of the notification message.
   */
   ...
   *          Fields of the notification message.
   */
  public void mandatoryNote(final JavaFileObject file, String key,
      Object... args) {
