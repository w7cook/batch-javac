...
/**
 * A delegated diagnostic formatter delegates all formatting actions to an
 * underlying formatter (aka the delegated formatter).
 * 
 * <p>
...
public class ForwardingDiagnosticFormatter<D extends Diagnostic<?>, F extends DiagnosticFormatter<D>>
  ...
  public ForwardingDiagnosticFormatter(F formatter) {
    ...
    this.configuration = new ForwardingConfiguration(
        formatter.getConfiguration());
  }
   ...
   */
  public static class ForwardingConfiguration implements
      DiagnosticFormatter.Configuration {

    /**
     * The configurationr object to which the forwarding configuration delegates
     * some settings
     */
