...
/**
 * An abstraction for internal compiler strings. They are stored in Utf8 format.
 * Names are stored in a Name.Table, and are unique within that table.
 * 
 * <p>
...
public abstract class Name implements javax.lang.model.element.Name {
  ...
  /**
   * Return the concatenation of this name, the given ASCII character, and name
   * `n'.
   */
  ...
  public boolean startsWith(Name prefix) {
    ...
    int i = 0;
    while (i < prefixLength && i < thisLength
  ...
  /*
   * Get a "reasonably small" value that uniquely identifies this name within
   * its name table.
   */
  ...
  public void getBytes(byte cs[], int start) {
    System.arraycopy(getByteArray(), getByteOffset(), cs, start,
        getByteLength());
  }

  /**
   * Get the underlying byte array for this name. The contents of the array must
   * not be modified.
   */
  ...
  public static abstract class Table {
    ...
    /**
     * Get the name for the bytes in array cs. Assume that bytes are in utf8
     * format.
     */
     ...
     */
    protected static boolean equals(byte[] bytes1, int offset1, byte[] bytes2,
