...
/**
 * A URLClassLoader that also implements Closeable. Reflection is used to access
 * internal data structures in the URLClassLoader, since no public API exists
 * for this purpose. Therefore this code is somewhat fragile. Caveat emptor.
 * 
 * @throws Error
 *           if the internal data structures are not as expected.
 * 
 *           <p>
 ...
 *           notice.</b>
 */
public class CloseableURLClassLoader extends URLClassLoader implements
    Closeable {
   ...
   * Reflection is used to access the jar files in the URLClassLoader's internal
   * data structures.
   * 
   * @throws java.io.IOException
   *           if the jar files cannot be found for any reson, or if closing the
   *           jar file itself causes an IOException.
   */
  @Override
  ...
  private ArrayList<?> getLoaders() throws NoSuchFieldException,
  ...
  private Object getField(Object o, Field f) throws IllegalArgumentException,
