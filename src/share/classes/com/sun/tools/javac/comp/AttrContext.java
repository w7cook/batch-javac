...
public class AttrContext {
  ...
  /**
   * Are arguments to current function applications boxed into an array for
   * varargs?
   */
  ...
  /**
   * The variable whose initializer is being attributed useful for detecting
   * self-references in variable initializers
   */
  Symbol enclVar = null;
