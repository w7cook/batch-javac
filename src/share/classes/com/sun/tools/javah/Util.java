 ...
 * 
 * For errors, the failure modes are: error -- User did something wrong bug --
 * Bug has occurred in javah fatal -- We can't even find resources, so bail
 * fast, don't localize
 * 
 * <p>
...
public class Util {
  ...
  public void version() throws Exit {
    log.println(getText("javah.version", System.getProperty("java.version"),
        null));
  }
