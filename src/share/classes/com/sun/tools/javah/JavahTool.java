...
public class JavahTool implements NativeHeaderTool {
  ...
  public NativeHeaderTask getTask(Writer out, JavaFileManager fileManager,
  ...
  public int run(InputStream in, OutputStream out, OutputStream err,
      String... arguments) {
    JavahTask t = new JavahTask(JavahTask.getPrintWriterForStream(out), null,
        null, Arrays.asList(arguments), null);
    return (t.run() ? 0 : 1);
  }
