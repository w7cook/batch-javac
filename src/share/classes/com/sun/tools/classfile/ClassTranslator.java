 ...
 */
public class ClassTranslator implements
    ConstantPool.Visitor<ConstantPool.CPInfo, Map<Object, Object>> {
  /**
   * Create a new ClassFile from {@code cf}, such that for all entries
   * {@code k&nbsp;-\&gt;&nbsp;v} in {@code translations}, each occurrence of
   * {@code k} in {@code cf} will be replaced by {@code v}. in
   * 
   * @param cf
   *          the class file to be processed
   * @param translations
   *          the set of translations to be applied
   * @return a copy of {@code} with the values in {@code translations}
   *         substituted
   */
  public ClassFile translate(ClassFile cf, Map<Object, Object> translations) {
    ...
    if (cf2 == null) {
      ...
      Method[] methods2 = translateMethods(cf.methods, cf.constant_pool,
          translations);
      Attributes attributes2 = translateAttributes(cf.attributes,
          cf.constant_pool, translations);

      if (constant_pool2 == cf.constant_pool && fields2 == cf.fields
          && methods2 == cf.methods && attributes2 == cf.attributes)
        cf2 = cf;
      else
        cf2 = new ClassFile(cf.magic, cf.minor_version, cf.major_version,
            constant_pool2, cf.access_flags, cf.this_class, cf.super_class,
            cf.interfaces, fields2, methods2, attributes2);
  ...
  ConstantPool.CPInfo translate(ConstantPool.CPInfo cpInfo,
    ...
    ConstantPool.CPInfo cpInfo2 = (ConstantPool.CPInfo) translations
        .get(cpInfo);
    if (cpInfo2 == null) {
  ...
  Field[] translate(Field[] fields, ConstantPool constant_pool,
      Map<Object, Object> translations) {
  ...
  Field translate(Field field, ConstantPool constant_pool,
      Map<Object, Object> translations) {
    Field field2 = (Field) translations.get(field);
    if (field2 == null) {
      Attributes attributes2 = translateAttributes(field.attributes,
          constant_pool, translations);

      if (attributes2 == field.attributes)
        field2 = field;
      else
        field2 = new Field(field.access_flags, field.name_index,
            field.descriptor, attributes2);
      translations.put(field, field2);
    }
    return field2;
  }

  Method[] translateMethods(Method[] methods, ConstantPool constant_pool,
      Map<Object, Object> translations) {
  ...
  Method translate(Method method, ConstantPool constant_pool,
      Map<Object, Object> translations) {
    Method method2 = (Method) translations.get(method);
    if (method2 == null) {
      Attributes attributes2 = translateAttributes(method.attributes,
          constant_pool, translations);

      if (attributes2 == method.attributes)
        method2 = method;
      else
        method2 = new Method(method.access_flags, method.name_index,
            method.descriptor, attributes2);
  ...
  public CPInfo visitClass(CONSTANT_Class_info info,
      Map<Object, Object> translations) {
  ...
  public CPInfo visitDouble(CONSTANT_Double_info info,
      Map<Object, Object> translations) {
  ...
  public CPInfo visitFieldref(CONSTANT_Fieldref_info info,
      Map<Object, Object> translations) {
    CONSTANT_Fieldref_info info2 = (CONSTANT_Fieldref_info) translations
        .get(info);
    if (info2 == null) {
      ConstantPool cp2 = translate(info.cp, translations);
      if (cp2 == info.cp)
        ...
        info2 = new CONSTANT_Fieldref_info(cp2, info.class_index,
  ...
  public CPInfo visitFloat(CONSTANT_Float_info info,
      Map<Object, Object> translations) {
  ...
  public CPInfo visitInteger(CONSTANT_Integer_info info,
      Map<Object, Object> translations) {
    CONSTANT_Integer_info info2 = (CONSTANT_Integer_info) translations
        .get(info);
    if (info2 == null) {
      info2 = info;
      translations.put(info, info2);
  ...
  public CPInfo visitInterfaceMethodref(CONSTANT_InterfaceMethodref_info info,
      Map<Object, Object> translations) {
    CONSTANT_InterfaceMethodref_info info2 = (CONSTANT_InterfaceMethodref_info) translations
        .get(info);
    if (info2 == null) {
      ConstantPool cp2 = translate(info.cp, translations);
      if (cp2 == info.cp)
        ...
        info2 = new CONSTANT_InterfaceMethodref_info(cp2, info.class_index,
            info.name_and_type_index);
      translations.put(info, info2);
    }
    return info;
  ...
  public CPInfo visitInvokeDynamic(CONSTANT_InvokeDynamic_info info,
      Map<Object, Object> translations) {
    CONSTANT_InvokeDynamic_info info2 = (CONSTANT_InvokeDynamic_info) translations
        .get(info);
    if (info2 == null) {
      ConstantPool cp2 = translate(info.cp, translations);
      if (cp2 == info.cp) {
        ...
        info2 = new CONSTANT_InvokeDynamic_info(cp2,
  ...
  public CPInfo visitLong(CONSTANT_Long_info info,
      Map<Object, Object> translations) {
  ...
  public CPInfo visitNameAndType(CONSTANT_NameAndType_info info,
      Map<Object, Object> translations) {
    ...
    if (info2 == null) {
      ...
      if (cp2 == info.cp)
        ...
        info2 = new CONSTANT_NameAndType_info(cp2, info.name_index,
            info.type_index);
      translations.put(info, info2);
    }
    return info;
  ...
  public CPInfo visitMethodref(CONSTANT_Methodref_info info,
      Map<Object, Object> translations) {
    CONSTANT_Methodref_info info2 = (CONSTANT_Methodref_info) translations
        .get(info);
    if (info2 == null) {
      ConstantPool cp2 = translate(info.cp, translations);
      if (cp2 == info.cp)
        ...
        info2 = new CONSTANT_Methodref_info(cp2, info.class_index,
            info.name_and_type_index);
      translations.put(info, info2);
    }
    return info;
  ...
  public CPInfo visitMethodHandle(CONSTANT_MethodHandle_info info,
      Map<Object, Object> translations) {
    CONSTANT_MethodHandle_info info2 = (CONSTANT_MethodHandle_info) translations
        .get(info);
    if (info2 == null) {
      ConstantPool cp2 = translate(info.cp, translations);
      if (cp2 == info.cp) {
        ...
        info2 = new CONSTANT_MethodHandle_info(cp2, info.reference_kind,
  ...
  public CPInfo visitMethodType(CONSTANT_MethodType_info info,
      Map<Object, Object> translations) {
    CONSTANT_MethodType_info info2 = (CONSTANT_MethodType_info) translations
        .get(info);
    if (info2 == null) {
      ConstantPool cp2 = translate(info.cp, translations);
      if (cp2 == info.cp) {
  ...
  public CPInfo visitString(CONSTANT_String_info info,
      Map<Object, Object> translations) {
  ...
  public CPInfo visitUtf8(CONSTANT_Utf8_info info,
      Map<Object, Object> translations) {
