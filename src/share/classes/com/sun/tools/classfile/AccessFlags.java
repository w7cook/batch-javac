...
public class AccessFlags {
  public static final int ACC_PUBLIC = 0x0001; // class, inner, field,
                                               // method
  ...
  public static final int ACC_FINAL = 0x0010; // class, inner, field,
                                              // method
  ...
  public static final int ACC_SYNTHETIC = 0x1000; // class, inner, field,
                                                  // method
  public static final int ACC_ANNOTATION = 0x2000; // class, inner
  public static final int ACC_ENUM = 0x4000; // class, inner, field
  public static final int ACC_MODULE = 0x8000; // class, inner, field,
                                               // method

  public static enum Kind {
    Class, InnerClass, Field, Method
  };
  ...
  private static final int[] classModifiers = { ACC_PUBLIC, ACC_FINAL,
      ACC_ABSTRACT, ACC_MODULE };

  private static final int[] classFlags = { ACC_PUBLIC, ACC_FINAL, ACC_SUPER,
  ...
  private static final int[] innerClassModifiers = { ACC_PUBLIC, ACC_PRIVATE,
      ACC_PROTECTED, ACC_STATIC, ACC_FINAL, ACC_ABSTRACT, ACC_MODULE };

  private static final int[] innerClassFlags = { ACC_PUBLIC, ACC_PRIVATE,
  ...
  private static final int[] fieldModifiers = { ACC_PUBLIC, ACC_PRIVATE,
      ACC_PROTECTED, ACC_STATIC, ACC_FINAL, ACC_VOLATILE, ACC_TRANSIENT,
      ACC_MODULE };

  private static final int[] fieldFlags = { ACC_PUBLIC, ACC_PRIVATE,
      ACC_PROTECTED, ACC_STATIC, ACC_FINAL, ACC_VOLATILE, ACC_TRANSIENT,
      ACC_SYNTHETIC, ACC_ENUM, ACC_MODULE };
  ...
  private static final int[] methodModifiers = { ACC_PUBLIC, ACC_PRIVATE,
      ACC_PROTECTED, ACC_STATIC, ACC_FINAL, ACC_SYNCHRONIZED, ACC_NATIVE,
      ACC_ABSTRACT, ACC_STRICT, ACC_MODULE };

  private static final int[] methodFlags = { ACC_PUBLIC, ACC_PRIVATE,
