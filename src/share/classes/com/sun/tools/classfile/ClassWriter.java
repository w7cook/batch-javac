...
public class ClassWriter {
  ...
  /**
   * Subtype of ByteArrayOutputStream with the convenience methods of a
   * DataOutputStream. Since ByteArrayOutputStream does not throw IOException,
   * there are no exceptions from the additional convenience methods either,
   */
   ...
   */
  protected static class ConstantPoolWriter implements
    ...
    public Integer visitFieldref(CONSTANT_Fieldref_info info,
    ...
    public Integer visitInteger(CONSTANT_Integer_info info,
        ClassOutputStream out) {
      out.writeInt(info.value);
      return 1;
    }

    public Integer visitInterfaceMethodref(
        CONSTANT_InterfaceMethodref_info info, ClassOutputStream out) {
      writeRef(info, out);
      return 1;
    }

    public Integer visitInvokeDynamic(CONSTANT_InvokeDynamic_info info,
        ClassOutputStream out) {
    ...
    public Integer visitNameAndType(CONSTANT_NameAndType_info info,
        ClassOutputStream out) {
      out.writeShort(info.name_index);
    ...
    public Integer visitMethodHandle(CONSTANT_MethodHandle_info info,
        ClassOutputStream out) {
    ...
    public Integer visitMethodType(CONSTANT_MethodType_info info,
        ClassOutputStream out) {
      out.writeShort(info.descriptor_index);
      return 1;
    }

    public Integer visitMethodref(CONSTANT_Methodref_info info,
        ClassOutputStream out) {
   ...
   */
  protected static class AttributeWriter implements
      Attribute.Visitor<Void, ClassOutputStream> {
    ...
    protected void writeCharacterRangeTableEntry(
        CharacterRangeTable_attribute.Entry entry, ClassOutputStream out) {
    ...
    protected void writeExceptionTableEntry(
        Code_attribute.Exception_data exception_data, ClassOutputStream out) {
    ...
    protected void writeLineNumberTableEntry(
        LineNumberTable_attribute.Entry entry, ClassOutputStream out) {
      out.writeShort(entry.start_pc);
    ...
    protected void writeLocalVariableTableEntry(
        LocalVariableTable_attribute.Entry entry, ClassOutputStream out) {
      out.writeShort(entry.start_pc);
    ...
    public Void visitLocalVariableTypeTable(
        LocalVariableTypeTable_attribute attr, ClassOutputStream out) {
      out.writeShort(attr.local_variable_table.length);
    ...
    protected void writeLocalVariableTypeTableEntry(
        LocalVariableTypeTable_attribute.Entry entry, ClassOutputStream out) {
      out.writeShort(entry.start_pc);
      out.writeShort(entry.length);
      out.writeShort(entry.name_index);
    ...
    public Void visitRuntimeVisibleAnnotations(
        RuntimeVisibleAnnotations_attribute attr, ClassOutputStream out) {
      annotationWriter.write(attr.annotations, out);
      return null;
    }

    public Void visitRuntimeInvisibleAnnotations(
        RuntimeInvisibleAnnotations_attribute attr, ClassOutputStream out) {
      annotationWriter.write(attr.annotations, out);
      return null;
    }

    public Void visitRuntimeVisibleParameterAnnotations(
        RuntimeVisibleParameterAnnotations_attribute attr, ClassOutputStream out) {
   ...
   */
  protected static class StackMapTableWriter implements
      stack_map_frame.Visitor<Void, ClassOutputStream> {
    ...
    public Void visit_same_locals_1_stack_item_frame(
        same_locals_1_stack_item_frame frame, ClassOutputStream out) {
      writeVerificationTypeInfo(frame.stack[0], out);
      return null;
    }

    public Void visit_same_locals_1_stack_item_frame_extended(
        same_locals_1_stack_item_frame_extended frame, ClassOutputStream out) {
    ...
    public Void visit_same_frame_extended(same_frame_extended frame,
        ClassOutputStream out) {
      out.writeShort(frame.offset_delta);
      return null;
    }
   ...
   */
  protected static class AnnotationWriter implements
      Annotation.element_value.Visitor<Void, ClassOutputStream> {
    ...
    public Void visitAnnotation(Annotation_element_value ev,
        ClassOutputStream out) {
