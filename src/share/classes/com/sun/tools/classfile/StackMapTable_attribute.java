...
public class StackMapTable_attribute extends Attribute {
  ...
  public StackMapTable_attribute(ConstantPool constant_pool,
      stack_map_frame[] entries) throws ConstantPoolException {
  ...
  public static abstract class stack_map_frame {
    ...
    public static interface Visitor<R, P> {
      ...
      R visit_same_locals_1_stack_item_frame(
          same_locals_1_stack_item_frame frame, P p);

      R visit_same_locals_1_stack_item_frame_extended(
          same_locals_1_stack_item_frame_extended frame, P p);
  ...
  public static class same_locals_1_stack_item_frame_extended extends
      stack_map_frame {
  ...
  public static class append_frame extends stack_map_frame {
    append_frame(int frame_type, ClassReader cr) throws IOException,
        InvalidStackMap {
      super(frame_type);
      offset_delta = cr.readUnsignedShort();
  ...
  public static class full_frame extends stack_map_frame {
    full_frame(int frame_type, ClassReader cr) throws IOException,
        InvalidStackMap {
      super(frame_type);
      offset_delta = cr.readUnsignedShort();
  ...
  public static class Uninitialized_variable_info extends
