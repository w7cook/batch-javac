...
public class ConstantPool {
  ...
  public static class UnexpectedEntry extends ConstantPoolException {
    ...
    public String getMessage() {
      // i18n?
      return "unexpected entry at #" + index + " -- expected tag "
          + expected_tag + ", found " + found_tag;
    }
  ...
  public static enum RefKind {
    REF_getField(1, "getfield"), REF_getStatic(2, "getstatic"), REF_putField(3,
        "putfield"), REF_putStatic(4, "putstatic"), REF_invokeVirtual(5,
        "invokevirtual"), REF_invokeStatic(6, "invokestatic"), REF_invokeSpecial(
        7, "invokespecial"), REF_newInvokeSpecial(8, "newinvokespecial"), REF_invokeInterface(
        9, "invokeinterface");
  ...
  private CPInfo get(int index, int expected_type) throws InvalidIndex,
      UnexpectedEntry {
  ...
  public CONSTANT_Utf8_info getUTF8Info(int index) throws InvalidIndex,
      UnexpectedEntry {
    return ((CONSTANT_Utf8_info) get(index, CONSTANT_Utf8));
  }

  public CONSTANT_Class_info getClassInfo(int index) throws InvalidIndex,
      UnexpectedEntry {
  ...
  public static abstract class CPInfo {
    ...
    /**
     * The number of slots in the constant pool used by this entry. 2 for
     * CONSTANT_Double and CONSTANT_Long; 1 for everything else.
     */
    public int size() {
      return 1;
    }
  ...
  public static abstract class CPRefInfo extends CPInfo {
    protected CPRefInfo(ConstantPool cp, ClassReader cr, int tag)
        throws IOException {
      super(cp);
      this.tag = tag;
    ...
    protected CPRefInfo(ConstantPool cp, int tag, int class_index,
  ...
  public static class CONSTANT_Fieldref_info extends CPRefInfo {
    ...
    public CONSTANT_Fieldref_info(ConstantPool cp, int class_index,
        int name_and_type_index) {
    ...
    @Override
    public String toString() {
      return "CONSTANT_Fieldref_info[class_index: " + class_index
  ...
  public static class CONSTANT_InterfaceMethodref_info extends CPRefInfo {
    CONSTANT_InterfaceMethodref_info(ConstantPool cp, ClassReader cr)
        throws IOException {
      super(cp, cr, CONSTANT_InterfaceMethodref);
    }

    public CONSTANT_InterfaceMethodref_info(ConstantPool cp, int class_index,
        int name_and_type_index) {
    ...
    @Override
    public String toString() {
      return "CONSTANT_InterfaceMethodref_info[class_index: " + class_index
          + ", name_and_type_index: " + name_and_type_index + "]";
    }
  ...
  public static class CONSTANT_InvokeDynamic_info extends CPInfo {
    CONSTANT_InvokeDynamic_info(ConstantPool cp, ClassReader cr)
        throws IOException {
      super(cp);
    ...
    public CONSTANT_InvokeDynamic_info(ConstantPool cp,
        int bootstrap_method_index, int name_and_type_index) {
      super(cp);
    ...
    @Override
    public String toString() {
      return "CONSTANT_InvokeDynamic_info[bootstrap_method_index: "
  ...
  public static class CONSTANT_MethodHandle_info extends CPInfo {
    CONSTANT_MethodHandle_info(ConstantPool cp, ClassReader cr)
        throws IOException {
      super(cp);
    ...
    public CONSTANT_MethodHandle_info(ConstantPool cp, RefKind ref_kind,
        int member_index) {
      super(cp);
    ...
    @Override
    public String toString() {
      return "CONSTANT_MethodHandle_info[ref_kind: " + reference_kind
          + ", member_index: " + reference_index + "]";
    }
  ...
  public static class CONSTANT_MethodType_info extends CPInfo {
    CONSTANT_MethodType_info(ConstantPool cp, ClassReader cr)
        throws IOException {
      super(cp);
  ...
  public static class CONSTANT_Methodref_info extends CPRefInfo {
    ...
    public CONSTANT_Methodref_info(ConstantPool cp, int class_index,
        int name_and_type_index) {
    ...
    @Override
    public String toString() {
      return "CONSTANT_Methodref_info[class_index: " + class_index
          + ", name_and_type_index: " + name_and_type_index + "]";
    }
  ...
  public static class CONSTANT_NameAndType_info extends CPInfo {
    CONSTANT_NameAndType_info(ConstantPool cp, ClassReader cr)
        throws IOException {
      super(cp);
      name_index = cr.readUnsignedShort();
    ...
    public CONSTANT_NameAndType_info(ConstantPool cp, int name_index,
        int type_index) {
      super(cp);
      this.name_index = name_index;
    ...
    @Override
    public String toString() {
      return "CONSTANT_NameAndType_info[name_index: " + name_index
