...
public abstract class Type {
  ...
  protected static void append(StringBuilder sb, String prefix,
      List<? extends Type> types, String suffix) {
    sb.append(prefix);
    String sep = "";
    for (Type t : types) {
      sb.append(sep);
  ...
  protected static void appendIfNotEmpty(StringBuilder sb, String prefix,
      List<? extends Type> types, String suffix) {
   ...
   * primitive type, such "{@code int}, {@code float}, etc or that of a type
   * argument, such as {@code T}, {@code K}, {@code V}, etc.
   * 
   * See: JVMS 4.3.2 BaseType: {@code B}, {@code C}, {@code D}, {@code F},
   * {@code I}, {@code J}, {@code S}, {@code Z}; VoidDescriptor: {@code V}; JVMS
   * 4.3.4 TypeVariableSignature: {@code T} Identifier {@code ;}
   */
  public static class SimpleType extends Type {
    ...
    private static final Set<String> primitiveTypes = new HashSet<String>(
        Arrays.asList("boolean", "byte", "char", "double", "float", "int",
            "long", "short", "void"));
   ...
   * 
   * See: JVMS 4.3.4 ArrayTypeSignature: {@code [} TypeSignature {@code ]}
   */
   ...
   * 
   * See; JVMS 4.3.4 MethodTypeSignature: FormalTypeParameters_opt {@code (}
   * TypeSignature* {@code)} ReturnType ThrowsSignature*
   */
  public static class MethodType extends Type {
    ...
    public MethodType(List<? extends TypeParamType> typeParamTypes,
        List<? extends Type> paramTypes, Type returnType,
  ...
  /**
   * Represents a class signature. These describe the signature of a class that
   * has type arguments.
   * 
   * See: JVMS 4.3.4 ClassSignature: FormalTypeParameters_opt
   * SuperclassSignature SuperinterfaceSignature*
   */
  public static class ClassSigType extends Type {
    public ClassSigType(List<TypeParamType> typeParamTypes,
        Type superclassType, List<Type> superinterfaceTypes) {
      this.typeParamTypes = typeParamTypes;
  ...
  /**
   * Represents a class type signature. This is used to represent a reference to
   * a class, such as in a field, parameter, return type, etc.
   * 
   * See: JVMS 4.3.4 ClassTypeSignature: {@code L} PackageSpecifier_opt
   * SimpleClassTypeSignature ClassTypeSignatureSuffix* {@code ;}
   * PackageSpecifier: Identifier {@code /} PackageSpecifier*
  ...
  public static class ClassType extends Type {
    ...
    @Override
    public boolean isObject() {
      return (outerType == null) && name.equals("java/lang/Object")
   ...
   * 
   * See: JVMS 4.3.4 FormalTypeParameters: {@code <} FormalTypeParameter+
   * {@code >} FormalTypeParameter: Identifier ClassBound InterfaceBound*
   * ClassBound: {@code :} FieldTypeSignature_opt InterfaceBound: {@code :}
   * FieldTypeSignature
   */
  public static class TypeParamType extends Type {
    public TypeParamType(String name, Type classBound,
  ...
  /**
   * Represents a wildcard type argument. A type argument that is not a wildcard
   * type argument will be represented by a ClassType, ArrayType, etc.
   * 
   * See: JVMS 4.3.4 TypeArgument: WildcardIndicator_opt FieldTypeSignature
   * {@code *} WildcardIndicator: {@code +} {@code -}
   */
