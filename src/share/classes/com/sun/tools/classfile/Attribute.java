...
public abstract class Attribute {
  ...
  public static class Factory {
    ...
    public Attribute createAttribute(ClassReader cr, int name_index, byte[] data)
      ...
      try {
        ...
        if (attrClass != null) {
          try {
            Class<?>[] constrArgTypes = { ClassReader.class, int.class,
                int.class };
            Constructor<? extends Attribute> constr = attrClass
                .getDeclaredConstructor(constrArgTypes);
            return constr.newInstance(new Object[] { cr, name_index,
                data.length });
          } catch (Throwable t) {
    ...
    protected void init() {
      ...
      standardAttributes.put(AnnotationDefault,
          AnnotationDefault_attribute.class);
      standardAttributes
          .put(BootstrapMethods, BootstrapMethods_attribute.class);
      standardAttributes.put(CharacterRangeTable,
          CharacterRangeTable_attribute.class);
      ...
      standardAttributes.put(LocalVariableTable,
          LocalVariableTable_attribute.class);
      standardAttributes.put(LocalVariableTypeTable,
          LocalVariableTypeTable_attribute.class);

      if (!compat) { // old javap does not recognize recent attributes
        standardAttributes.put(CompilationID, CompilationID_attribute.class);
        standardAttributes.put(RuntimeInvisibleAnnotations,
            RuntimeInvisibleAnnotations_attribute.class);
        standardAttributes.put(RuntimeInvisibleParameterAnnotations,
            RuntimeInvisibleParameterAnnotations_attribute.class);
        standardAttributes.put(RuntimeVisibleAnnotations,
            RuntimeVisibleAnnotations_attribute.class);
        standardAttributes.put(RuntimeVisibleParameterAnnotations,
            RuntimeVisibleParameterAnnotations_attribute.class);
        standardAttributes.put(Signature, Signature_attribute.class);
        standardAttributes.put(SourceID, SourceID_attribute.class);
      }

      standardAttributes.put(SourceDebugExtension,
          SourceDebugExtension_attribute.class);
  ...
  public String getName(ConstantPool constant_pool)
  ...
  public interface Visitor<R, P> {
    ...
    R visitRuntimeVisibleAnnotations(RuntimeVisibleAnnotations_attribute attr,
        P p);

    R visitRuntimeInvisibleAnnotations(
        RuntimeInvisibleAnnotations_attribute attr, P p);

    R visitRuntimeVisibleParameterAnnotations(
        RuntimeVisibleParameterAnnotations_attribute attr, P p);

    R visitRuntimeInvisibleParameterAnnotations(
        RuntimeInvisibleParameterAnnotations_attribute attr, P p);
