 ...
 * Subtypes of {@code Dependency} may provide additional detail about the
 * dependency.
 * 
...
public interface Dependency {
  ...
  /**
   * A location somewhere within a class. Subtypes of {@code Location} may be
   * used to provide additional detail about the location.
   */
  public interface Location {
    /**
     * Get the name of the class containing the location. This name will be used
     * to locate the class file for transitive dependency analysis.
     * 
