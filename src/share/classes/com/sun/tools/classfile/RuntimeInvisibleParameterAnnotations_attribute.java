 ...
 */
public class RuntimeInvisibleParameterAnnotations_attribute extends
    RuntimeParameterAnnotations_attribute {
  RuntimeInvisibleParameterAnnotations_attribute(ClassReader cr,
      int name_index, int length) throws IOException,
  ...
  public RuntimeInvisibleParameterAnnotations_attribute(ConstantPool cp,
    ...
    this(cp.getUTF8Index(Attribute.RuntimeInvisibleParameterAnnotations),
