...
/**
 * See JVMS <TBD> http://cr.openjdk.java.net/~jrose/pres/indy-javadoc-mlvm/
 * 
 * <p>
...
public class BootstrapMethods_attribute extends Attribute {
  ...
  public BootstrapMethods_attribute(int name_index,
      BootstrapMethodSpecifier[] bootstrap_method_specifiers) {
  ...
  public static class BootstrapMethodSpecifier {
    ...
    public BootstrapMethodSpecifier(int bootstrap_method_ref,
