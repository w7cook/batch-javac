 ...
 * of an annotation type. Sure it ought to be called "Annotation", but that
 * clashes with java.lang.annotation.Annotation.
 * 
...
public class AnnotationDescImpl implements AnnotationDesc {
  ...
  /**
   * Returns this annotation's elements and their values. Only those explicitly
   * present in the annotation are included, not those assuming their default
   * values. Returns an empty array if there are none.
   */
  ...
  /**
   * Returns a string representation of this annotation. String is of one of the
   * forms:
   * 
   * @com.example.foo(name1=val1, name2=val2)
   * @com.example.foo(val)
   * @com.example.foo Omit parens for marker annotations, and omit "value=" when
   *                  allowed.
   */
  @Override
  ...
  /**
   * Represents an association between an annotation type element and one of its
   * values.
   */
