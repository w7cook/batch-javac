...
public class AnnotationValueImpl implements AnnotationValue {
  ...
  private class ValueVisitor implements Attribute.Visitor {
    ...
    public void visitConstant(Attribute.Constant c) {
      if (c.type.tag == TypeTags.BOOLEAN) {
        ...
        value = Boolean.valueOf(((Integer) c.value).intValue() != 0);
      } else {
        value = c.value;
      }
    }
    ...
    public void visitClass(Attribute.Class c) {
      value = TypeMaker.getType(env, env.types.erasure(c.type));
    }
   ...
   * 
   * @return the text of a Java language annotation value expression whose value
   *         is the value of this annotation type element.
   */
  @Override
