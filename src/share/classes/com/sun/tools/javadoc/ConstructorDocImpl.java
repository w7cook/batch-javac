...
public class ConstructorDocImpl extends ExecutableMemberDocImpl implements
    ConstructorDoc {
  ...
  /**
   * Returns a string representation of this constructor. Includes the qualified
   * signature and any type parameters. Type parameters precede the class name,
   * as they do in the syntax for invoking constructors with explicit type
   * parameters using "new". (This is unlike the syntax for invoking methods
