 ...
 */
class SerialFieldTagImpl extends TagImpl implements SerialFieldTag,
    Comparable<Object> {
  ...
  private String description; // Optional Remaining Arguments of
                              // serialField

  private ClassDoc containingClass; // Class containing
                                    // serialPersistentField member
  private ClassDoc fieldTypeDoc; // ClassDocImpl of fieldType
  private FieldDocImpl matchingField; // FieldDocImpl with same name as
                                      // fieldName
   ...
   * 
   * serialField serializableFieldName serisliableFieldType description of
   * field.
   * 
  ...
  private void parseSerialFieldString() {
    ...
    for (inx += Character.charCount(cp); inx < len; inx += Character
        .charCount(cp)) {
      cp = text.codePointAt(inx);
  ...
  /*
   * Optional. Link this serialField tag to its corrsponding field in the class.
   * Note: there is no requirement that there be a field in the class that
   * matches serialField tag.
   */
