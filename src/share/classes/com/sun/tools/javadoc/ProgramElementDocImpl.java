 ...
 */
public abstract class ProgramElementDocImpl extends DocImpl implements
    ProgramElementDoc {
  ...
  protected ProgramElementDocImpl(DocEnv env, Symbol sym, String doc,
      JCTree tree, Position.LineMap lineMap) {
    super(env, doc);
    this.sym = sym;
    this.tree = tree;
   ...
   * 
   * @return a ClassDocImpl for this element's containing class. If this is a
   *         class with no outer class, return null.
   */
  ...
  /**
   * Return the package that this member is contained in. Return "" if in
   * unnamed package.
   */
  ...
  /**
   * Get the annotations of this program element. Return an empty array if there
   * are none.
   */
