 ...
 * exception name and exception comment. The exception name my be the name of a
 * type variable. Note: @exception is a backwards compatible synonymy for
 * 
 * @throws.
 * 
 * @author Robert Field
...
class ThrowsTagImpl extends TagImpl implements ThrowsTag {
  ...
  /**
   * Return the type that represents the exception. This may be a
   * <code>ClassDoc</code> or a <code>TypeVariable</code>.
   */
  ...
  /**
   * Return the kind of this tag. Always "@throws" for instances of
   * ThrowsTagImpl.
   */
  public String kind() {
    return "@throws";
