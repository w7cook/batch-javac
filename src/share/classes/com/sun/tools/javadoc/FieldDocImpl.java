...
public class FieldDocImpl extends MemberDocImpl implements FieldDoc {
  ...
  public FieldDocImpl(DocEnv env, VarSymbol sym, String rawDocs,
      JCVariableDecl tree, Position.LineMap lineMap) {
   ...
   * Get the value of a constant field.
   * 
   * @return the text of a Java language expression whose value is the value of
   *         the constant. The expression uses no identifiers other than
