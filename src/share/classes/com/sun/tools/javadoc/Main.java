...
public class Main {
   ...
   * @param args
   *          The command line parameters.
   * @param docletParentClassLoader
   *          The parent class loader used when creating the doclet classloader.
   *          If null, the class loader used to instantiate doclets will be
   *          created without specifying a parent class loader.
   * @return The return code.
   * @since 1.7
   */
  ...
  public static int execute(String programName,
      ClassLoader docletParentClassLoader, String... args) {
  ...
  public static int execute(String programName, PrintWriter errWriter,
      PrintWriter warnWriter, PrintWriter noticeWriter,
      String defaultDocletClassName, ClassLoader docletParentClassLoader,
      String... args) {
    Start jdoc = new Start(programName, errWriter, warnWriter, noticeWriter,
        defaultDocletClassName, docletParentClassLoader);
    return jdoc.begin(args);
  }
}
