...
/**
 * Utility for integrating with javadoc tools and for localization. Handle
 * Resources. Access to error and warning counts. Message formatting. <br>
...
public class Messager extends Log implements DocErrorReporter {
  ...
  public static void preRegister(Context context, final String programName,
      final PrintWriter errWriter, final PrintWriter warnWriter,
    ...
    if (messageRB == null) {
      try {
        messageRB = ResourceBundle
            .getBundle("com.sun.tools.javadoc.resources.javadoc");
  ...
  String getText(String key, String a1, String a2, String a3, String a4) {
    try {
      ...
      return "********** Resource for javadoc is broken. There is no " + key
          + " key in resource.";
    }
  }
  ...
  public void printWarning(SourcePosition pos, String msg) {
    if (nwarnings < MaxWarnings) {
      String prefix = (pos == null) ? programName : pos.toString();
      warnWriter.println(prefix + ": " + getText("javadoc.warning") + " - "
          + msg);
      warnWriter.flush();
      nwarnings++;
    }
  ...
  /**
   * Return total number of errors, including those recorded in the compilation
   * log.
   */
  public int nerrors() {
    return nerrors;
  ...
  /**
   * Return total number of warnings, including those recorded in the
   * compilation log.
   */
  ...
  public void exitNotice() {
    ...
    if (nwarnings > 0) {
      notice((nwarnings > 1) ? "main.warnings" : "main.warning", "" + nwarnings);
    }
  }
