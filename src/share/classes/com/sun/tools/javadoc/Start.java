...
class Start {
  ...
  Start(String programName, PrintWriter errWriter, PrintWriter warnWriter,
    ...
    Context tempContext = new Context(); // interim context until option
                                         // decoding completed
    messager = new Messager(tempContext, programName, errWriter, warnWriter,
        noticeWriter);
  ...
  private boolean parseAndExecute(String... argv) throws IOException {
    ...
    Messager.preRegister(context, messager.programName, messager.errWriter,
        messager.warnWriter, messager.noticeWriter);
