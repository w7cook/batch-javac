...
class DocLocale {
  ...
  /**
   * The locale name will be set by Main, if option is provided on the command
   * line.
   */
  final String localeName;

  /**
   * The locale to be used. If user doesen't provide this, then set it to
   * default locale value.
   */
  final Locale locale;

  /**
   * The collator for this application. This is to take care of Locale Specific
   * or Natural Language Text sorting.
   */
  ...
  /**
   * True is we should use <code>BreakIterator</code> to compute first sentence.
   */
   ...
   */
  static final String[] sentenceTerminators = { "<p>", "</p>", "<h1>", "<h2>",
      "<h3>", "<h4>", "<h5>", "<h6>", "</h1>", "</h2>", "</h3>", "</h4>",
      "</h5>", "</h6>", "<hr>", "<pre>", "</pre>" };
  ...
  /**
   * Get the locale if specified on the command line else return null and if
   * locale option is not used then return default locale.
   */
  ...
  /**
   * Return the first sentence of a string, where a sentence ends with a period
   * followed be white space.
   */
  ...
  /**
   * Find out if there is any HTML tag in the given string. If found return true
   * else return false.
   */
