...
public abstract class ExecutableMemberDocImpl extends MemberDocImpl implements
    ExecutableMemberDoc {
  ...
  public boolean isVarArgs() {
    return ((sym.flags() & Flags.VARARGS) != 0 && !env.legacyDoclet);
  }
   ...
   * 
   * @return an array of ThrowTagImpl containing all {@code @exception} and
   *         {@code @throws} tags.
   */
  ...
  /**
   * Return exceptions this method or constructor throws. Each array element is
   ...
   * @see ParameterImpl
   * 
   * @return an array of ParameterImpl, one element per argument in the order
   *         the arguments are present.
   */
  ...
  /**
   * Return the formal type parameters of this method or constructor. Return an
  ...
  /**
   * Get flat signature. All types are not qualified. Return a String, which is
   * the flat signiture of this member. It is the parameter list, type is not
   * qualified. For instance, for a method
