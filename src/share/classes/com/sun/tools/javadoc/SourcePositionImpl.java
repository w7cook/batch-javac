 ...
 * @author Michael Van De Vanter (position representation changed to char
 *         offsets)
 */
public class SourcePositionImpl implements SourcePosition {
  ...
  /**
   * The line in the source file. The first line is numbered 1; 0 means no line
  ...
  public String toString() {
    ...
    if (fn.endsWith(")")) {
      ...
      if (paren != -1)
        fn = fn.substring(0, paren) + File.separatorChar
