...
public class PackageDocImpl extends DocImpl implements PackageDoc {
  ...
  public boolean setDocPath = false; // Flag to avoid setting doc
                                     // path multiple times.
   ...
   * Constructor
   */
  public PackageDocImpl(DocEnv env, PackageSymbol sym, String documentation,
      JCTree tree) {
  ...
  /**
   * Cache of all classes contained in this package, including member classes of
   * those classes, and their member classes, etc. Includes only those classes
   * at the specified protection level and weaker.
   */
  private List<ClassDocImpl> allClassesFiltered = null;

  /**
   * Cache of all classes contained in this package, including member classes of
   * those classes, and their member classes, etc.
   */
  private List<ClassDocImpl> allClasses = null;

  /**
   * Return a list of all classes contained in this package, including member
   * classes of those classes, and their member classes, etc.
   */
  ...
  /**
   * Get ordinary classes (that is, exclude exceptions, errors, enums,
   * interfaces, and annotation types) in this package.
   * 
  ...
  public AnnotationDesc[] annotations() {
    AnnotationDesc res[] = new AnnotationDesc[sym.getAnnotationMirrors()
        .length()];
    int i = 0;
   ...
   * Get package name.
   * 
   * Note that we do not provide a means of obtaining the simple name of a
   * package -- package names are always returned in their uniquely qualified
   * form.
   */
  public String name() {
  ...
  /**
   * Invoked when a source of package doc comments is located. Emits a
   * diagnostic if this is the second one.
   */
  ...
  public SourcePosition position() {
    return (tree != null) ? SourcePositionImpl.make(tree.sourcefile, tree.pos,
        tree.lineMap) : SourcePositionImpl.make(docPath, Position.NOPOS, null);
  }
}
