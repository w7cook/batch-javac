...
public interface PackageDoc extends Doc {
  ...
  /**
   * Get all classes and interfaces in the package, filtered to the specified <a
   * href="{@docRoot} /com/sun/javadoc/package-summary.html#included">access
   * modifier option</a>.
   * 
   * @return filtered classes and interfaces in this package
   * @param filter
   *          Specifying true filters according to the specified access modifier
   *          option. Specifying false includes all classes and interfaces
  ...
  /**
   * Get all <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#included">included</a> classes and
   * interfaces in the package. Same as allClasses(true).
   * 
  ...
  /**
   * Get included <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#class">ordinary</a> classes (that is,
   * exclude exceptions, errors, enums, interfaces, and annotation types) in
   * this package.
   * 
