...
public interface ClassDoc extends ProgramElementDoc, Type {
   ...
   * 
   * @return the ClassDoc for the superclass of this class, null if there is no
   *         superclass.
   * @see #superclassType
   */
  ClassDoc superclass();
  ...
  /**
   * Test whether this class is a subclass of the specified class. If this is an
   * interface, return false for all classes except
   ...
   * interfaces. Return an empty array if there are no interfaces.
   * 
   * @return an array of interfaces, each represented by a <code>ClassDoc</code>
   *         or a <code>ParametrizedType</code>.
   * @since 1.5
   */
  Type[] interfaceTypes();
  ...
  /**
   * Return the type parameter tags of this class or interface. Return an empty
  ...
  /**
   * Return <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#included">included</a> fields in this
   * class or interface. Excludes enum constants if this is an enum type.
   * 
   ...
   * 
   * @param filter
   *          Specify true to filter according to the specified access modifier
   *          option. Specify false to include all fields regardless of access
   *          modifier option.
   * @return an array of FieldDoc objects representing the included fields in
   *         this class or interface.
   */
  ...
  /**
   * Return the enum constants if this is an enum type. Return an empty array if
   * there are no enum constants, or if this is not an enum type.
   * 
  ...
  /**
   * Return <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#included">included</a> methods in
   * this class or interface. Same as <code>methods(true)</code>.
   * 
   * @return an array of MethodDoc objects representing the included methods in
   *         this class or interface. Does not include constructors or
   ...
   * @param filter
   *          Specify true to filter according to the specified access modifier
   *          option. Specify false to include all methods regardless of access
   *          modifier option.
   * @return an array of MethodDoc objects representing the included methods in
   *         this class or interface.
   */
  ...
  /**
   * Return <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#included">included</a> constructors
   * in this class. An array containing the default no-arg constructor is
   * returned if no other constructors exist. Return empty array if this is an
   * interface.
   * 
  ...
  /**
   * Return constructors in this class, filtered to the specified <a
   * href="{@docRoot} /com/sun/javadoc/package-summary.html#included">access
   ...
   * @param filter
   *          Specify true to filter according to the specified access modifier
   *          option. Specify false to include all constructors regardless of
  ...
  /**
   * Return <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#included">included</a> nested classes
   * and interfaces within this class or interface. This includes both static
   * and non-static nested classes. (This method should have been named
   * <code>nestedClasses()</code>, as inner classes are technically non-static.)
   * Anonymous and local classes or interfaces are not included.
   * 
   * @return an array of ClassDoc objects representing the included classes and
   *         interfaces defined in this class or interface.
   */
  ClassDoc[] innerClasses();

  /**
   * Return nested classes and interfaces within this class or interface
   * filtered to the specified <a href="{@docRoot}
   * /com/sun/javadoc/package-summary.html#included">access modifier option</a>.
   * This includes both static and non-static nested classes. Anonymous and
   * local classes are not included.
   * 
   * @param filter
   *          Specify true to filter according to the specified access modifier
   *          option. Specify false to include all nested classes regardless of
   *          access modifier option.
   ...
   * Search order: 1) qualified name, 2) nested in this class or interface, 3)
   * in this package, 4) in the class imports, 5) in the package imports. Return
   ...
   * called "single-type-import declarations" in <cite>The Java&trade; Language
   * Specification</cite>.
   * 
