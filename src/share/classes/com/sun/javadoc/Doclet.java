 ...
 * <code>start(RootDoc)</code> method, as described in the <a
 * href="package-summary.html#package_description">package description</a>. If
 * the doclet takes command line options, it must also implement
...
public abstract class Doclet {
   ...
   * would return 2.
   * <P>
   * This method is required if the doclet contains any options. If this method
   * is missing, Javadoc will print an invalid flag error for every option.
   * 
   * @return number of arguments on the command line for an option including the
   ...
   * considered valid if this method is not present. It will default gracefully
   * (to true) if absent.
   * <P>
