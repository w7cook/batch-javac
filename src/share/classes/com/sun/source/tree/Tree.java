...
public interface Tree {
  ...
  public enum Kind {
    ...
    /**
     * Used for instances of {@link UnaryTree} representing postfix increment
     * operator {@code ++}.
     */
    POSTFIX_INCREMENT(UnaryTree.class),

    /**
     * Used for instances of {@link UnaryTree} representing postfix decrement
     * operator {@code --}.
     */
    ...
    /**
     * Used for instances of {@link UnaryTree} representing unary plus operator
     * {@code +}.
     */
    UNARY_PLUS(UnaryTree.class),

    /**
     * Used for instances of {@link UnaryTree} representing unary minus operator
     * {@code -}.
     */
    UNARY_MINUS(UnaryTree.class),

    /**
     * Used for instances of {@link UnaryTree} representing bitwise complement
     * operator {@code ~}.
     */
    BITWISE_COMPLEMENT(UnaryTree.class),

    /**
     * Used for instances of {@link UnaryTree} representing logical complement
     * operator {@code !}.
     */
    ...
    /**
     * Used for instances of {@link BinaryTree} representing addition or string
     * concatenation {@code +}.
     */
    ...
    /**
     * Used for instances of {@link BinaryTree} representing greater-than-equal
     * {@code >=}.
     */
    ...
    /**
     * Used for instances of {@link BinaryTree} representing bitwise and logical
     * "and" {@code &}.
     */
    ...
    /**
     * Used for instances of {@link CompoundAssignmentTree} representing left
     * shift assignment {@code <<=}.
     */
    LEFT_SHIFT_ASSIGNMENT(CompoundAssignmentTree.class),

    /**
     * Used for instances of {@link CompoundAssignmentTree} representing right
     * shift assignment {@code >>=}.
     */
    ...
    /**
     * Used for instances of {@link CompoundAssignmentTree} representing bitwise
     * and logical "and" assignment {@code &=}.
     */
    AND_ASSIGNMENT(CompoundAssignmentTree.class),

    /**
     * Used for instances of {@link CompoundAssignmentTree} representing bitwise
     * and logical "xor" assignment {@code ^=}.
     */
    XOR_ASSIGNMENT(CompoundAssignmentTree.class),

    /**
     * Used for instances of {@link CompoundAssignmentTree} representing bitwise
     * and logical "or" assignment {@code |=}.
     */
    ...
    /**
     * Used for instances of {@link LiteralTree} representing a floating-point
     * literal expression of type {@code float}.
     */
    FLOAT_LITERAL(LiteralTree.class),

    /**
     * Used for instances of {@link LiteralTree} representing a floating-point
     * literal expression of type {@code double}.
     */
    DOUBLE_LITERAL(LiteralTree.class),

    /**
     * Used for instances of {@link LiteralTree} representing a boolean literal
     * expression of type {@code boolean}.
     */
    ...
    /**
     * Used for instances of {@link LiteralTree} representing a string literal
     * expression of type {@link String}.
     */
    ...
    /**
     * Used for instances of {@link WildcardTree} representing a super bounded
     * wildcard type argument.
     */
    ...
    /**
     * An implementation-reserved node. This is the not the node you are looking
     * for.
     */
    OTHER(null);
  ...
  /**
   * Accept method used to implement the visitor pattern. The visitor pattern is
   * used to implement operations on trees.
   * 
   * @param <R>
