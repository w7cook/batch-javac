...
public abstract class Trees {
  ...
  public static Trees instance(CompilationTask task) {
    if (!task.getClass().getName()
        .equals("com.sun.tools.javac.api.JavacTaskImpl"))
  ...
  private static Trees getJavacTrees(Class<?> argType, Object arg) {
    try {
      ...
      Class<?> c = Class.forName("com.sun.tools.javac.api.JavacTrees", false,
          cl);
  ...
  /**
   * Gets the Tree node for a given Element. Returns null if the node can not be
   * found.
   */
  ...
  /**
   * Gets the MethodTree node for a given ExecutableElement. Returns null if the
   * node can not be found.
   */
  public abstract MethodTree getTree(ExecutableElement method);

  /**
   * Gets the Tree node for an AnnotationMirror on a given Element. Returns null
  ...
  /**
   * Gets the TreePath node for an AnnotationMirror on a given Element. Returns
   * null if the node can not be found.
   */
  public abstract TreePath getPath(Element e, AnnotationMirror a);

  /**
   * Gets the TreePath node for an AnnotationValue for an AnnotationMirror on a
   * given Element. Returns null if the node can not be found.
   */
  public abstract TreePath getPath(Element e, AnnotationMirror a,
      AnnotationValue v);
  ...
  /**
   * Gets the Element for the Tree node identified by a given TreePath. Returns
   * null if the element is not available.
   * 
   * @throws IllegalArgumentException
   *           is the TreePath does not identify a Tree node that might have an
   *           associated Element.
   */
