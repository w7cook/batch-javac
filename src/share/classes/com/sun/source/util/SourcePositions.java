...
public interface SourcePositions {
   ...
   * file, or if the starting position is not available, return
   * {@link javax.tools.Diagnostic#NOPOS}. The returned position must be at the
   * start of the yield of this tree, that is for any sub-tree of this tree, the
   * following must hold:
   * 
   * <p>
   ...
   * file, or if the starting position is not available, return
   * {@link javax.tools.Diagnostic#NOPOS}. The returned position must be at the
   * end of the yield of this tree, that is for any sub-tree of this tree, the
   * following must hold:
   * 
   * <p>
