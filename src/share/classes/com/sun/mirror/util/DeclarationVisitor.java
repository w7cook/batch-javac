...
/**
 * A visitor for declarations, in the style of the standard visitor design
 * pattern. Classes implementing this interface are used to operate on a
 * declaration when the kind of declaration is unknown at compile time. When a
 * visitor is passed to a declaration's {@link Declaration#accept accept}
 * method, the most specific <tt>visit<i>Xxx</i></tt> method applicable to that
 * declaration is invoked.
 * 
 * @deprecated All components of this API have been superseded by the
 *             standardized annotation processing API. The replacement for the
 *             functionality of this interface is
 *             {@link javax.lang.model.element.ElementVisitor}.
 * 
