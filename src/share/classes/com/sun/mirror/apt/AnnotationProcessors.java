...
public class AnnotationProcessors {
  ...
  static class CompositeAnnotationProcessor implements AnnotationProcessor {
     ...
     * 
     * @param aps
     *          the component annotation processors
     */
    ...
    /**
     * Invokes the <tt>process</tt> method of each component processor, in the
     * order in which the processors were passed to the constructor.
     */
    public void process() {
      for (AnnotationProcessor ap : aps)
        ap.process();
  ...
  /**
   * An annotation processor that does nothing and has no state. May be used
   * multiple times.
   * 
   * @since 1.5
   */
  ...
  /**
   * Constructs a new composite annotation processor. A composite annotation
   * processor combines multiple annotation processors into one and functions by
   * invoking each of its component processors' process methods in sequence.
   * 
   * @param aps
   *          The processors to create a composite of
   * @since 1.5
   */
  public static AnnotationProcessor getCompositeAnnotationProcessor(
   ...
   * Constructs a new composite annotation processor. A composite annotation
   * processor combines multiple annotation processors into one and functions by
   * invoking each of its component processors' process methods in the sequence
   * the processors are returned by the collection's iterator.
   * 
   * @param aps
   ...
   */
  public static AnnotationProcessor getCompositeAnnotationProcessor(
      Collection<AnnotationProcessor> aps) {
    return new CompositeAnnotationProcessor(aps);
  }
}
