 ...
 * 
 * <p>
 * While this class extends the serializable <tt>EventObject</tt>, it cannot
 * meaningfully be serialized because all of the annotation processing tool's
 * internal state would potentially be needed.
 * 
...
public abstract class RoundCompleteEvent extends java.util.EventObject {
  ...
  /**
   * The current <tt>AnnotationProcessorEnvironment</tt> is regarded as the
   * source of events.
   * 
   * @param source
