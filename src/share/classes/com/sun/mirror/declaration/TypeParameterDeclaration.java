...
/**
 * Represents a formal type parameter of a generic type, method, or constructor
 * declaration. A type parameter declares a {@link TypeVariable}.
 * 
...
public interface TypeParameterDeclaration extends Declaration {
  ...
  /**
   * Returns the bounds of this type parameter. These are the types given by the
   * <i>extends</i> clause. If there is no explicit <i>extends</i> clause, then
  ...
  /**
   * Returns the type, method, or constructor declaration within which this type
