...
public interface ExecutableDeclaration extends MemberDeclaration {
  ...
  /**
   * Returns the formal type parameters of this method or constructor. They are
   * returned in declaration order.
   * 
   * @return the formal type parameters of this method or constructor, or an
   *         empty collection if there are none
   */
  Collection<TypeParameterDeclaration> getFormalTypeParameters();

  /**
   * Returns the formal parameters of this method or constructor. They are
   * returned in declaration order.
   * 
   * @return the formal parameters of this method or constructor, or an empty
   ...
   * 
   * @return the exceptions and other throwables listed in the <tt>throws</tt>
