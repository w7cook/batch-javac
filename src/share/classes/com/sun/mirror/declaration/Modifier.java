 ...
 * 
 * <p>
 * Not all modifiers are applicable to all kinds of declarations. When two or
 * more modifiers appear in the source code of a declaration, then it is
 * customary, though not required, that they appear in the same order as the
 * constants listed in the detail section below.
 * 
