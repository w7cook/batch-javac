...
public interface AnnotationTypeDeclaration extends InterfaceDeclaration {
  ...
  /**
   * Returns the annotation type elements of this annotation type. These are the
   * methods that are directly declared in the type's declaration.
   * 
   * @return the annotation type elements of this annotation type, or an empty
