...
public interface AnnotationValue {
   ...
   * <li> {@code Collection<AnnotationValue>} (representing the elements, in
   * order, if the value is an array)
   * </ul>
   * 
   * @return the value
   */
   ...
   * indicates only approximately where an annotation value begins.
   * 
