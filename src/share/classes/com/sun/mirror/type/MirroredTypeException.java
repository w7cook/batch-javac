 ...
 *             {@link javax.lang.model.type.MirroredTypeException}.
 * 
...
public class MirroredTypeException extends RuntimeException {
   ...
   * mirror may be unavailable if this exception has been serialized and then
   * read back in.
   * 
  ...
  /**
   * Returns the fully qualified name of the type being accessed. More
   * precisely, returns the canonical name of a class, interface, array, or
   * primitive, and returns <tt>"void"</tt> for the pseudo-type representing the
   * type of <tt>void</tt>.
   * 
